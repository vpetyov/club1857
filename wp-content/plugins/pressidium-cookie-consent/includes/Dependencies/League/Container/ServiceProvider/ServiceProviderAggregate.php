...
use Generator;
use Pressidium\WP\CookieConsent\Dependencies\League\Container\{ContainerAwareInterface, ContainerAwareTrait};
use Pressidium\WP\CookieConsent\Dependencies\League\Container\Exception\ContainerException;
...
class ServiceProviderAggregate implements ServiceProviderAggregateInterface
{
    ...
    public function add($provider) : ServiceProviderAggregateInterface
    {
        ...
        throw new ContainerException(
            ...
            'of (\Pressidium\WP\CookieConsent\Dependencies\League\Container\ServiceProvider\ServiceProviderInterface)'
        );
    }
