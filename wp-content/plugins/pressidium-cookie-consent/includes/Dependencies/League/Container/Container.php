...
namespace Pressidium\WP\CookieConsent\Dependencies\League\Container;

use Pressidium\WP\CookieConsent\Dependencies\League\Container\Definition\{DefinitionAggregate, DefinitionInterface, DefinitionAggregateInterface};
use Pressidium\WP\CookieConsent\Dependencies\League\Container\Exception\{NotFoundException, ContainerException};
use Pressidium\WP\CookieConsent\Dependencies\League\Container\Inflector\{InflectorAggregate, InflectorInterface, InflectorAggregateInterface};
use Pressidium\WP\CookieConsent\Dependencies\League\Container\ServiceProvider\{
    ServiceProviderAggregate,
    ServiceProviderAggregateInterface,
    ServiceProviderInterface
};
use Pressidium\WP\CookieConsent\Dependencies\Psr\Container\ContainerInterface;
