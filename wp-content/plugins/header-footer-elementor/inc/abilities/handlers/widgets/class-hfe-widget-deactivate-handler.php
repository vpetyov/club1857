...
/**
 * Class HFE_Widget_Deactivate_Handler
 *
 * Implements HFE_Ability_Handler for the widgets/deactivate ability.
 *
 * @since 2.9.0
 */
class HFE_Widget_Deactivate_Handler implements HFE_Ability_Handler {
	...
	public function get_registration_args() {
		return [
			'label'               => __( 'Deactivate Widget', 'header-footer-elementor' ),
			'description'         => __( 'Disable a specific widget by slug.', 'header-footer-elementor' ),
			...
			'input_schema'        => [
				...
				'properties' => [
					'widget_slug' => [
						'type'        => 'string',
						'description' => __( 'Widget slug to deactivate.', 'header-footer-elementor' ),
					],
				],
			],
			'output_schema'       => [
	...
	public function execute( $input ) {
		...
		$saved_widgets[ $widget['class_name'] ] = 'disabled';
		update_option( '_hfe_widgets', $saved_widgets );

		return [
			'success'     => true,
			'widget_slug' => $slug,
			'message'     => __( 'Widget deactivated.', 'header-footer-elementor' ),
		];
	}
