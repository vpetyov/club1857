 ...
 *
 * @deprecated latest Use {@see 'Constants::wsaldefaults_build_links'} instead.
 *
 * @return array
 */
function wsaldefaults_build_links( $link_aliases = array() ) {

	// _deprecated_function( __METHOD__, '5.3.0', 'Constants::wsaldefaults_build_links()' );
...
function set_wsal_alerts() {
	...
	$wsal_default_events = array(
		...
		esc_html__( 'Content & Comments', 'wp-security-audit-log' ) => array(
			esc_html__( 'Content', 'wp-security-audit-log' ) => array(
				...
				array(
					...
					Constants::wsaldefaults_build_links( array( 'AttachmentUrl' ) ),
					'file',
					'uploaded',
				),
				array(
				...
				array(
					...
					Constants::wsaldefaults_build_links( array( 'RevisionLink', 'EditorLinkPost', 'PostUrlIfPublished' ) ),
					'post',
					'modified',
				),
				array(
			...
			esc_html__( 'Tags', 'wp-security-audit-log' )  => array(
				...
				array(
					...
					Constants::wsaldefaults_build_links( array( 'TagLink' ) ),
					'tag',
					'created',
				),
				array(
			...
			esc_html__( 'Categories', 'wp-security-audit-log' ) => array(
				...
				array(
					...
					Constants::wsaldefaults_build_links( array( 'cat_link' ) ),
					'category',
					'renamed',
				),
				array(
			...
			esc_html__( 'Custom Fields', 'wp-security-audit-log' ) => array(
				array(
					...
					Constants::wsaldefaults_build_links( array( 'EditorLinkPost', 'MetaLink', 'PostUrlIfPublished' ) ),
					'post',
					'modified',
				),
				array(
			...
			esc_html__( 'Custom Fields (ACF)', 'wp-security-audit-log' ) => array(
				array(
					...
					Constants::wsaldefaults_build_links( array( 'EditorLinkPost', 'MetaLink' ) ),
					'custom-field',
					'modified',
				),
				array(
			...
			esc_html__( 'Comments', 'wp-security-audit-log' ) => array(
				array(
					...
					array(
						...
						esc_html__( 'Comment status', 'wp-security-audit-log' )  => '%CommentStatus%',
					),
					Constants::wsaldefaults_build_links( array( 'PostUrlIfPublished', 'CommentLink' ) ),
					'comment',
					'approved',
				),
				array(
				...
				array(
					...
					Constants::wsaldefaults_build_links( array( 'PostUrlIfPublished', 'CommentLinkWpAdmin' ) ),
					'comment',
					'unapproved',
				),
				array(
			...
			esc_html__( 'Menus', 'wp-security-audit-log' ) => array(
				array(
					...
					array(),
					Constants::wsaldefaults_build_links( array( 'MenuUrl' ) ),
					'menu',
					'created',
				),
				array(
		...
		esc_html__( 'User Accounts', 'wp-security-audit-log' ) => array(
			esc_html__( 'User Profiles', 'wp-security-audit-log' ) => array(
				...
				array(
					...
					Constants::wsaldefaults_build_links( array( 'EditUserLink', 'MetaLink' ) ),
					'user',
					'modified',
				),
				array(
		...
		esc_html__( 'Plugins & Themes', 'wp-security-audit-log' ) => array(
			esc_html__( 'Plugins', 'wp-security-audit-log' ) => array(
				array(
					...
					__( 'Installed the plugin %PluginData->Name%.', 'wp-security-audit-log' ),
					array(
						esc_html__( 'Version', 'wp-security-audit-log' )          => '%PluginData->Version%',
						esc_html__( 'Install location', 'wp-security-audit-log' ) => '%PluginData->plugin_dir_path%',
					),
				...
				array(
					5030,
					WSAL_HIGH,
					esc_html__( 'A plugin failed to install', 'wp-security-audit-log' ),
					esc_html__( 'The plugin %name% failed to install.', 'wp-security-audit-log' ),
					array(
						esc_html__( 'Install location', 'wp-security-audit-log' )     => '%install_directory%',
					),
					array(),
				...
				array(
					5034,
					WSAL_INFORMATIONAL,
					esc_html__( 'Translation files for a plugin updated.', 'wp-security-audit-log' ),
					__( 'Translation files for the plugin %plugin_name% updated.', 'wp-security-audit-log' ),
					array(
						esc_html__( 'Language', 'wp-security-audit-log' ) => '%language%',
					),
					array(),
					'plugin',
					'updated',
			...
			esc_html__( 'Themes', 'wp-security-audit-log' ) => array(
				...
				array(
					5035,
					WSAL_INFORMATIONAL,
					esc_html__( 'Translation files for a theme updated.', 'wp-security-audit-log' ),
					__( 'Translation files for the theme %theme_name% updated.', 'wp-security-audit-log' ),
					array(
						esc_html__( 'Language', 'wp-security-audit-log' ) => '%language%',
					),
					array(),
		...
		esc_html__( 'Activity Logs', 'wp-security-audit-log' ) => array(
			...
			esc_html__( 'Activity log plugin', 'wp-security-audit-log' ) => array(
				...
				array(
					...
					esc_html__( 'Purged the activity log', 'wp-security-audit-log' ),
					array(
						esc_html__( 'Number of events deleted', 'wp-security-audit-log' ) => '%PurgedCount%',
					),
					array(),
					'wp-activity-log',
					'deleted',
				...
				array(
					...
					array(
						esc_html__( 'Old header', 'wp-security-audit-log' ) => '%old_header%',
						esc_html__( 'New header', 'wp-security-audit-log' ) => '%new_header%',
						esc_html__( 'Status', 'wp-security-audit-log' ) => '%EventValue%',
					),
					array(),
					'wp-activity-log',
					'enabled',
			...
			esc_html__( 'Notifications & Integrations', 'wp-security-audit-log' ) => array(
				...
				array(
					6319,
					WSAL_LOW,
					esc_html__( 'Changed the status of the Weekly Summary of Activity Log', 'wp-security-audit-log' ),
					__( 'Changed the status of the <strong>Weekly Summary of Activity Log.</strong>.', 'wp-security-audit-log' ),
					array(),
					array(),
					'wp-activity-log',
					'enabled',
				...
				array(
					6328,
					WSAL_LOW,
					esc_html__( 'Modified the recipients of the Weekly Summary of Activity Log.', 'wp-security-audit-log' ),
					__( 'Modified the recipients of the <strong>Weekly Summary of Activity Log</strong>.', 'wp-security-audit-log' ),
					array(
						esc_html__( 'New recipient', 'wp-security-audit-log' ) => '%recipient%',
						esc_html__( 'Previous recipient', 'wp-security-audit-log' ) => '%previous_recipient%',
					),
		...
		esc_html__( 'WordPress & System', 'wp-security-audit-log' ) => array(
			esc_html__( 'System', 'wp-security-audit-log' ) => array(
				...
				array(
					6080,
					WSAL_INFORMATIONAL,
					esc_html__( 'WordPress core translation files updated.', 'wp-security-audit-log' ),
					esc_html__( 'WordPress core translation files updated.', 'wp-security-audit-log' ),
					array(
						esc_html__( 'Language', 'wp-security-audit-log' ) => '%language%',
					),
			...
			esc_html__( 'WordPress Site Settings', 'wp-security-audit-log' ) => array(
				...
				array(
					...
					__( 'Changed the <strong>WordPress address (URL)</strong> to %new_url%.', 'wp-security-audit-log' ),
					array(
