...
/***/ "../modules/atomic-form/assets/js/editor/component.js"
/*!************************************************************!*\
  !*** ../modules/atomic-form/assets/js/editor/component.js ***!
  \************************************************************/
...
var hooks = _interopRequireWildcard(__webpack_require__(/*! ./hooks */ "../modules/atomic-form/assets/js/editor/hooks/index.js"));
...
/***/ "../modules/atomic-form/assets/js/editor/hooks/data/regenerate-cssid/create-element.js"
/*!*********************************************************************************************!*\
  !*** ../modules/atomic-form/assets/js/editor/hooks/data/regenerate-cssid/create-element.js ***!
  \*********************************************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
var _regenerateCssid = __webpack_require__(/*! ../../../utils/regenerate-cssid */ "../modules/atomic-form/assets/js/editor/utils/regenerate-cssid.js");
class CreateElement extends $e.modules.hookData.After {
  getCommand() {
  ...
  apply(args, result) {
    (Array.isArray(result) ? result : [result]).filter(Boolean).forEach(container => (0, _regenerateCssid.regenerateCssIds)(container, {
      recursive: false
    }));
  }
}
...
/***/ "../modules/atomic-form/assets/js/editor/hooks/data/regenerate-cssid/duplicate-element.js"
/*!************************************************************************************************!*\
  !*** ../modules/atomic-form/assets/js/editor/hooks/data/regenerate-cssid/duplicate-element.js ***!
  \************************************************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
__webpack_require__(/*! core-js/modules/esnext.iterator.for-each.js */ "../node_modules/core-js/modules/esnext.iterator.for-each.js");
var _regenerateCssid = __webpack_require__(/*! ../../../utils/regenerate-cssid */ "../modules/atomic-form/assets/js/editor/utils/regenerate-cssid.js");
class DuplicateElement extends $e.modules.hookData.After {
  getCommand() {
  ...
  apply(args, result) {
    (Array.isArray(result) ? result : [result]).filter(Boolean).forEach(_regenerateCssid.regenerateCssIds);
  }
}
...
/***/ "../modules/atomic-form/assets/js/editor/hooks/data/regenerate-cssid/import-element.js"
/*!*********************************************************************************************!*\
  !*** ../modules/atomic-form/assets/js/editor/hooks/data/regenerate-cssid/import-element.js ***!
  \*********************************************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
__webpack_require__(/*! core-js/modules/esnext.iterator.for-each.js */ "../node_modules/core-js/modules/esnext.iterator.for-each.js");
var _regenerateCssid = __webpack_require__(/*! ../../../utils/regenerate-cssid */ "../modules/atomic-form/assets/js/editor/utils/regenerate-cssid.js");
class ImportElement extends $e.modules.hookData.After {
  getCommand() {
...
/***/ "../modules/atomic-form/assets/js/editor/hooks/data/regenerate-cssid/paste-element.js"
/*!********************************************************************************************!*\
  !*** ../modules/atomic-form/assets/js/editor/hooks/data/regenerate-cssid/paste-element.js ***!
  \********************************************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
__webpack_require__(/*! core-js/modules/esnext.iterator.for-each.js */ "../node_modules/core-js/modules/esnext.iterator.for-each.js");
var _regenerateCssid = __webpack_require__(/*! ../../../utils/regenerate-cssid */ "../modules/atomic-form/assets/js/editor/utils/regenerate-cssid.js");
class PasteElement extends $e.modules.hookData.After {
  getCommand() {
...
exports.PasteElement = PasteElement;

/***/ },

/***/ "../modules/atomic-form/assets/js/editor/hooks/index.js"
/*!**************************************************************!*\
  !*** ../modules/atomic-form/assets/js/editor/hooks/index.js ***!
  \**************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
var _createElement = __webpack_require__(/*! ./data/regenerate-cssid/create-element */ "../modules/atomic-form/assets/js/editor/hooks/data/regenerate-cssid/create-element.js");
var _duplicateElement = __webpack_require__(/*! ./data/regenerate-cssid/duplicate-element */ "../modules/atomic-form/assets/js/editor/hooks/data/regenerate-cssid/duplicate-element.js");
var _pasteElement = __webpack_require__(/*! ./data/regenerate-cssid/paste-element */ "../modules/atomic-form/assets/js/editor/hooks/data/regenerate-cssid/paste-element.js");
var _importElement = __webpack_require__(/*! ./data/regenerate-cssid/import-element */ "../modules/atomic-form/assets/js/editor/hooks/data/regenerate-cssid/import-element.js");

/***/ },

/***/ "../modules/atomic-form/assets/js/editor/utils/regenerate-cssid.js"
/*!*************************************************************************!*\
  !*** ../modules/atomic-form/assets/js/editor/utils/regenerate-cssid.js ***!
  \*************************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
exports.regenerateCssIds = regenerateCssIds;
...
__webpack_require__(/*! core-js/modules/esnext.iterator.for-each.js */ "../node_modules/core-js/modules/esnext.iterator.for-each.js");
const LABEL_WIDGET_TYPE = 'e-form-label';
const NON_FIELD_FORM_WIDGETS = new Set(['e-form', LABEL_WIDGET_TYPE, 'e-form-submit-button']);
function getAtomicFormFieldTypes() {
  return Object.keys(window.elementor?.config?.widgets ?? {}).filter(type => type.startsWith('e-form') && !NON_FIELD_FORM_WIDGETS.has(type));
}
function getElementChildren(model) {
  const childModels = model?.get('elements')?.models ?? [];
  return [model, ...childModels.flatMap(getElementChildren)];
}
...
function regenerateInputCssId(model) {
  const oldCssId = getSettingsJson(model)._cssid?.value;
  if (!oldCssId) {
    return null;
  }
...
function relinkLabel(model, idMap) {
  const currentInputId = getSettingsJson(model)['input-id']?.value;
  if (!currentInputId || !idMap.has(currentInputId)) {
    return;
  }
  updateSettings(model, {
    'input-id': {
...
function regenerateCssIds(container, {
  recursive = true
} = {}) {
  ...
  models.filter(isAtomicFormInput).forEach(model => {
    ...
    if (result) {
      idMap.set(result.oldCssId, result.newCssId);
    }
  });
  if (idMap.size) {
    models.filter(isLabel).forEach(model => relinkLabel(model, idMap));
  }
}
...
"use strict";
/*!*********************************************************!*\
  !*** ../modules/atomic-form/assets/js/editor/module.js ***!
  \*********************************************************/


var _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ "../node_modules/@babel/runtime/helpers/interopRequireDefault.js");
var _component = _interopRequireDefault(__webpack_require__(/*! ./component */ "../modules/atomic-form/assets/js/editor/component.js"));
