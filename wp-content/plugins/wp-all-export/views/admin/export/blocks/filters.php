...
<div class="wpallexport-free-edition-notice" style="padding: 20px; margin-bottom: 10px;">
	<a class="upgrade_link" target="_blank" href="https://www.wpallimport.com/checkout/?edd_action=add_to_cart&download_id=5839967&discount=welcome-upgrade-99&edd_options%5Bprice_id%5D=1&utm_source=export-plugin-free&utm_medium=upgrade-notice&utm_campaign=filters"><?php esc_html_e('Upgrade to the Pro edition of WP All Export to Add Filters','wp-all-export');?></a>
...
<div class="wp_all_export_rule_inputs">
	<table>
		<tr>
			<th><?php esc_html_e('Element', 'wp-all-export'); ?></th>
			<th><?php esc_html_e('Rule', 'wp-all-export'); ?></th>
			<th><?php esc_html_e('Value', 'wp-all-export'); ?></th>
			<th>&nbsp;</th>
		</tr>
		<tr>
			<td style="width: 25%;">
				<select id="wp_all_export_xml_element">
					<option value=""><?php esc_html_e('Select Element', 'wp-all-export'); ?></option>
					<?php
                        // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- render_filters() builds <option> tags from registered fields with internal escaping
			...
			<td style="width: 25%;" id="wp_all_export_available_rules">
				<select id="wp_all_export_rule">
					<option value=""><?php esc_html_e('Select Rule', 'wp-all-export'); ?></option>
				</select>
			</td>
			<td style="width: 25%;">
			...
			<td style="width: 15%;">
				<a id="wp_all_export_add_rule" href="javascript:void(0);"><?php esc_html_e('Add Rule', 'wp-all-export');?></a>
			</td>
		</tr>
	</table>						
</div>	
<div id="wpallexport-filters" style="padding:0;">								
	<div class="wpallexport-content-section" style="padding:0; border: none;">					
		<fieldset id="wp_all_export_filtering_rules">					
			...
			?>
			<p id="date_field_notice" style="margin: 5px 0px 20px; text-align: center;"><?php echo wp_kses(__('Date filters use natural language.<br>For example, to return records created in the last week: <i>date ▸ newer than ▸ last week</i>.<br>For all records created in 2016: <i>date ▸ older than ▸ 1/1/2017</i> AND <i>date ▸ newer than ▸ 12/31/2015</i>', 'wp-all-export'), array('br' => array(), 'i' => array()));?>.</p>
			<p id="no_options_notice" style="margin:20px 0 5px; text-align:center; <?php if ( ! empty($filter_rules_hierarhy) and is_array($filter_rules_hierarhy) ) echo 'display:none;';?>"><?php esc_html_e('No filtering options. Add filtering options to only export records matching some specified criteria.', 'wp-all-export');?></p>
			<ol class="wp_all_export_filtering_rules">
				<?php							
					
					$condition_labels = array(
						'default' => array(
							'equals' => __('equals', 'wp-all-export'),
							'not_equals' => __("doesn't equal", 'wp-all-export'),
							'greater' => __('greater than', 'wp-all-export'),
							'equals_or_greater' => __('equal to or greater than', 'wp-all-export'),
							'less' => __('less than', 'wp-all-export'),
							'equals_or_less' => __('equal to or less than', 'wp-all-export'),
							'contains' => __('contains', 'wp-all-export'),
							'not_contains' => __("doesn't contain", 'wp-all-export'),
							'is_empty' => __('is empty', 'wp-all-export'),
							'is_not_empty' => __('is not empty', 'wp-all-export'),
							'in' => __('In', 'wp-all-export'),
							'not_in' => __('Not In', 'wp-all-export')
						),
						'date' => array(
							'equals' => __('equals', 'wp-all-export'),
							'not_equals' => __("doesn't equal", 'wp-all-export'),
							'greater' => __('newer than', 'wp-all-export'),
							'equals_or_greater' => __('equal to or newer than', 'wp-all-export'),
							'less' => __('older than', 'wp-all-export'),
							'equals_or_less' => __('equal to or older than', 'wp-all-export'),
							'contains' => __('contains', 'wp-all-export'),
							'not_contains' => __("doesn't contain", 'wp-all-export'),
							'is_empty' => __('is empty', 'wp-all-export'),
							'is_not_empty' => __('is not empty', 'wp-all-export'),
						...
						{						
							...
							{								
								...
								<li id="<?php echo esc_attr("item_" . $rulenumber);?>" class="dragging">
									...
									<?php wp_all_export_reverse_rules_html($filter_rules_hierarhy, $rule, $rulenumber, $condition_labels); ?>
								</li>
								<?php
							}
						}
