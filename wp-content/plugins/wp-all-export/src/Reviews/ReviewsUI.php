...
class ReviewsUI
{
    ...
    public function render()
    {
        ...
        if($this->reviewLogic->shouldShowReviewModal()) {
            ...
            <input type="hidden" id="wpae-modal-type" value="<?php echo esc_attr($this->reviewLogic->getModalType()); ?>" />
            <div style="" class="notice notice-info wpae-reviews-notice">
                ...
                <div id="wpae-ask-for-review">
                    ...
                    <div class="wpae-buttons-container wpae-review-buttons">
                        <button data-review="good"><?php esc_html_e('Good', 'wp-all-export'); ?></button>
                        <button data-review="ok"><?php esc_html_e('Just Ok', 'wp-all-export'); ?></button>
                        <button data-review="bad"><?php esc_html_e('Bad', 'wp-all-export'); ?></button>
                    </div>
                </div>
                <div id="wpae-review">
                    <h1><?php esc_html_e('That is great to hear, thank you for the feedback!', 'wp-all-export'); ?></h1>
                    <p>    
                        <?php esc_html_e("Would you be willing to do us a small favor? Unhappy customers are quick to publicly complain, but happy customers rarely speak up and share their good experiences.", 'wp-all-export'); ?>
                        </br>
                        <?php esc_html_e("If you have a moment, we would love for you to review our add-on in the WordPress.org plugin repository.", 'wp-all-export'); ?>
                    </p>
                    <div class="wpae-buttons-container">
                        <a class="review-link" href="<?php echo esc_attr($this->reviewLogic->getReviewLink()); ?>" target="_blank">
                            ...
                            <button><?php printf(esc_html__('Review the %s', 'wp-all-export'), esc_html($this->reviewLogic->getPluginName()) ); ?></button>
                        </a>
                    </div>
                </div>
                <div id="wpae-feedback">
                    <div class="wpae-review-form">
                        <h1><?php esc_html_e('Thank you for your feedback, it really helps us improve our products.', 'wp-all-export'); ?></h1>
                        <p><?php esc_html_e('If you could improve one thing about WP All Export, what would it be?', 'wp-all-export'); ?></p>
                        <textarea id="wpae-feedback-message"></textarea>
                        <div class="wpae-submit-feedback">
                            <button><?php esc_html_e('Submit', 'wp-all-export'); ?></button>
                        </div>
                    </div>
                    <div class="wpae-submit-confirmation">
                        Thank you for your feedback. Your message was emailed to support@wpallimport.com from <?php echo esc_html(get_option('admin_email')); ?>. If you do not receive a confirmation email, it means we didn't receive your message for some reason.
                    </div>
