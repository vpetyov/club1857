...
<section id="brand">
  <div class="fontawesome-icon-list">
    ...
    <ul id="cnss-fa-ul">
      ...
      <li><a href="#airbnb"><i class="fa-brands fa-airbnb"></i><br><span class="label">Airbnb</span></a></li>
      ...
      <li><a href="#bilibili"><i class="fa-brands fa-bilibili"></i><br><span class="label">Bilibili</span></a></li>
      <li><a href="#brave"><i class="fa-brands fa-brave"></i><br><span class="label">Brave</span></a></li>
      ...
      <li><a href="#cloudflare"><i class="fa-brands fa-cloudflare"></i><br><span class="label">Cloudflare</span></a></li>
      ...
      <li><a href="#dailymotion"><i class="fa-brands fa-dailymotion"></i><br><span class="label">Dailymotion</span></a></li>
      <li><a href="#deezer"><i class="fa-brands fa-deezer"></i><br><span class="label">Deezer</span></a></li>
      ...
      <li><a href="#instagram-square"><i class="fa-brands fa-square-instagram"></i><br><span class="label">Instagram Square</span></a></li>
      ...
      <li><a href="#letterboxd"><i class="fa-brands fa-letterboxd"></i><br><span class="label">Letterboxd</span></a></li>
      <li><a href="#letterboxd-square"><i class="fa-brands fa-square-letterboxd"></i><br><span class="label">Letterboxd Square</span></a></li>
      ...
      <li><a href="#medium"><i class="fa-brands fa-medium"></i><br><span class="label">Medium</span></a></li>
      ...
      <li><a href="#signal-messenger"><i class="fa-brands fa-signal-messenger"></i><br><span class="label">Signal Messenger</span></a></li>
      ...
      <li><a href="#shopify"><i class="fa-brands fa-shopify"></i><br><span class="label">Shopify</span></a></li>
      <li><a href="#swift"><i class="fa-brands fa-swift"></i><br><span class="label">Swift</span></a></li>
      ...
      <li><a href="#unsplash"><i class="fa-brands fa-unsplash"></i><br><span class="label">Unsplash</span></a></li>
      <li><a href="#unity"><i class="fa-brands fa-unity"></i><br><span class="label">Unity</span></a></li>
