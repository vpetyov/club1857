 ...
 *
 */
class Imagify_WPMedia_Mixpanel extends Imagify_WPMedia_Base_MixpanelBase {


    /**
     * An instance of the MixpanelPeople class (used to create/update profiles)
     * @var Imagify_WPMedia_Producers_MixpanelPeople
     */
    public $people;
     ...
     * @var Imagify_WPMedia_Producers_MixpanelEvents
     */
    private $_events;
    ...
    public function __construct($token, $options = array()) {
        ...
        $this->people = new Imagify_WPMedia_Producers_MixpanelPeople($token, $options);
        $this->_events = new Imagify_WPMedia_Producers_MixpanelEvents($token, $options);
        $this->group = new Imagify_WPMedia_Producers_MixpanelGroups($token, $options);
    }
     ...
     * @param $token
     * @param array $options
     * @return Imagify_WPMedia_Mixpanel
     */
    public static function getInstance($token, $options = array()) {
        if(!isset(self::$_instances[$token])) {
            self::$_instances[$token] = new Imagify_WPMedia_Mixpanel($token, $options);
        }
