...
const bucket_writable = derived$1( config, $config => $config.bucket_writable );
...
const bapa = derived$1( [settings, storage_provider], ( [$settings, $storage_provider] ) => {
...
const ooe = derived$1( [settings, storage_provider], ( [$settings, $storage_provider] ) => {
...
const licence = derived$1( config, $config => $config.hasOwnProperty( "licences" ) ? $config.licences.at( 0 ) : [] );

// Convenience readable store of offload remaining with count message, derived from config.
const offloadRemainingWithCount = derived$1( config, $config => $config.offload_remaining_with_count );

// Convenience readable store of documentation, derived from config.
const documentation = derived$1( config, $config => $config.documentation );
...
const toolsLocked = writable( false );
...
function createAssetsSettings() {
	...
	return {
		...
		set,
		async save() {
			const json = await api.put( "assets-settings", get$1( this ) );
		...
		reset() {
			set( { ...get$1( currentAssetsSettings ) } );
		},
		async fetch() {
		...
		updateSettings( json ) {
			if (
				...
				const dirty = get$1( assetsSettingsChanged );
				const previousSettings = { ...get$1( currentAssetsSettings ) }; // cloned
				...
				// If the settings weren't changed before, they shouldn't be now.
				if ( !dirty && get$1( assetsSettingsChanged ) ) {
					assetsSettings.reset();
				}

				// If settings are in middle of being changed when changes come in
				// from server, reset to server version.
				if ( dirty && objectsDiffer( [previousSettings, get$1( currentAssetsSettings )] ) ) {
...
const assetsSettings = createAssetsSettings();

// Have the assets settings been changed from current server side settings?
const assetsSettingsChanged = derived$1( [assetsSettings, currentAssetsSettings], objectsDiffer );
...
var root$x = add_locations(from_html(`<div><!></div>`), Page[FILENAME], [[41, 0]]);
...
var root_1$J = add_locations(from_html(`<img/>`), Button[FILENAME], [[86, 2]]);
var root$w = add_locations(from_html(`<button><!> <!></button>`), Button[FILENAME], [[65, 0]]);
...
var root_1$I = add_locations(from_html(`<div class="icon type"><img class="icon type"/></div>`), Notification[FILENAME], [[122, 3, [[123, 4]]]]);
var root_4$a = add_locations(from_html(`<p></p>`), Notification[FILENAME], [[131, 7]]);
var root_5$c = add_locations(from_html(`<h3></h3>`), Notification[FILENAME], [[133, 7]]);
var root_6$7 = add_locations(from_html(`<button class="dismiss"> </button> <!>`, 1), Notification[FILENAME], [[137, 6]]);
var root_8$7 = add_locations(from_html(`<button class="icon close"></button>`), Notification[FILENAME], [[142, 6]]);
var root_2$f = add_locations(from_html(`<div class="heading"><!> <!></div>`), Notification[FILENAME], [[128, 4]]);
var root_9$5 = add_locations(from_html(`<p></p>`), Notification[FILENAME], [[148, 4]]);
var root_10$3 = add_locations(from_html(`<p class="links"></p>`), Notification[FILENAME], [[151, 4]]);
var root$v = add_locations(from_html(`<div><div class="content"><!> <div class="body"><!> <!> <!> <!></div></div> <!></div>`), Notification[FILENAME], [[108, 0, [[120, 1, [[126, 2]]]]]]);
...
var root_5$b = add_locations(from_html(`<p></p>`), Notifications[FILENAME], [[35, 6]]);
var root_1$H = add_locations(from_html(`<div id="notifications" class="notifications wrapper"></div>`), Notifications[FILENAME], [[29, 1]]);
...
var root_1$G = add_locations(from_html(`<div><img class="notice-icon svelte-1gifctk"/></div>`), SubNavItem[FILENAME], [[27, 3, [[28, 4]]]]);
var root$u = add_locations(from_html(`<li><a> <!></a></li>`), SubNavItem[FILENAME], [[15, 0, [[16, 1]]]]);
...
var root_3$i = add_locations(from_html(`<li class="step-arrow"><img alt=""/></li>`), SubNav[FILENAME], [[30, 4, [[31, 5]]]]);
var root_2$e = add_locations(from_html(`<!> <!>`, 1), SubNav[FILENAME], []);
var root_1$F = add_locations(from_html(`<ul></ul>`), SubNav[FILENAME], [[25, 1]]);
...
var root_1$E = add_locations(from_html(`<div><!> <!></div>`), SubPages[FILENAME], [[24, 1]]);
...
var root$t = add_locations(from_html(`<div><!></div>`), SubPage[FILENAME], [[15, 0]]);
...
var root$s = add_locations(from_html(`<div><!></div>`), PanelContainer[FILENAME], [[12, 0]]);
...
var root_1$D = add_locations(from_html(`<div class="gradient svelte-q90jdq"></div>`), PanelRow[FILENAME], [[23, 2]]);
var root$r = add_locations(from_html(`<div><!> <!></div>`), PanelRow[FILENAME], [[21, 0]]);
...
var root_1$C = add_locations(from_html(`<p class="wp-config"> </p>`), DefinedInWPConfig[FILENAME], [[14, 1]]);
...
var root$q = add_locations(from_html(`<div><input type="checkbox"/> <label class="toggle-label"><!></label></div>`), ToggleSwitch[FILENAME], [[19, 0, [[20, 1], [26, 1]]]]);
...
var root_1$B = add_locations(from_html(`<a class="help" target="_blank"><img class="icon help"/></a>`), HelpButton[FILENAME], [[25, 1, [[26, 2]]]]);
...
var root_1$A = add_locations(from_html(`<div class="heading"><h2> </h2> <!> <!></div>`), Panel[FILENAME], [[130, 2, [[131, 3]]]]);
var root_7$4 = add_locations(from_html(`<!>  <h3> </h3>`, 1), Panel[FILENAME], [[150, 5]]);
var root_9$4 = add_locations(from_html(`<h3> </h3>`), Panel[FILENAME], [[152, 5]]);
var root_12$4 = add_locations(from_html(`<div class="provider"><a href="/storage/provider" class="link"><img/> </a></div>`), Panel[FILENAME], [[159, 5, [[160, 6, [[161, 7]]]]]]);
var root_6$6 = add_locations(from_html(`<!> <!> <!> <!> <!>`, 1), Panel[FILENAME], []);
var root_4$9 = add_locations(from_html(`<!> <!>`, 1), Panel[FILENAME], []);
var root$p = add_locations(from_html(`<div><!> <!></div>`), Panel[FILENAME], [[115, 0]]);
...
var root_1$z = add_locations(from_html(`<img class="svelte-oic18e"/> <div class="provider-details svelte-oic18e"><h3 class="svelte-oic18e"> </h3> <p class="console-details svelte-oic18e"><a class="console svelte-oic18e" target="_blank"> </a> <span class="region svelte-oic18e"> </span></p></div> <!>`, 1), StorageSettingsHeadingRow[FILENAME], [[24, 1], [25, 1, [[26, 2], [27, 2, [[28, 3], [29, 3]]]]]]);
...
var root$o = add_locations(from_html(`<div class="check-again svelte-qs7gng"><!> <span class="last-update"> </span></div>`), CheckAgain[FILENAME], [[42, 0, [[52, 1]]]]);
...
var root$n = add_locations(from_html(`<div><div class="content in-panel"><div class="icon type in-panel"><img class="icon type"/></div> <div class="body"></div> <!></div></div>`), SettingsValidationStatusRow[FILENAME], [[26, 0, [[33, 1, [[34, 2, [[35, 3]]], [38, 2]]]]]]);
...
var root_3$h = add_locations(from_html(`<p></p>`), SettingNotifications[FILENAME], [[51, 3]]);
...
var root_2$d = add_locations(from_html(`<!>  <h4> </h4>`, 1), SettingsPanelOption[FILENAME], [[119, 3]]);
var root_4$8 = add_locations(from_html(`<h4> </h4>`), SettingsPanelOption[FILENAME], [[121, 3]]);
var root_1$y = add_locations(from_html(`<!> <!>`, 1), SettingsPanelOption[FILENAME], []);
var root_5$a = add_locations(from_html(`<p></p>`), SettingsPanelOption[FILENAME], [[126, 2]]);
var root_7$3 = add_locations(from_html(`<input type="text" minlength="1" size="10"/> <label> </label>`, 1), SettingsPanelOption[FILENAME], [[130, 3], [143, 3]]);
var root_8$6 = add_locations(from_html(`<p class="input-error"> </p>`), SettingsPanelOption[FILENAME], [[148, 3]]);
var root_6$5 = add_locations(from_html(`<!> <!>`, 1), SettingsPanelOption[FILENAME], []);
var root$m = add_locations(from_html(`<div><!> <!> <!> <!> <!> <!></div>`), SettingsPanelOption[FILENAME], [[110, 0]]);
...
var root_1$x = add_locations(from_html(`<!> <!> <!> <!> <!> <!> <!>`, 1), StorageSettingsPanel[FILENAME], []);
...
var root_1$w = add_locations(from_html(`<img class="svelte-1azw2tb"/> <div class="provider-details svelte-1azw2tb"><h3 class="svelte-1azw2tb"> </h3> <p class="console-details svelte-1azw2tb"><a class="console svelte-1azw2tb" target="_blank"> </a></p></div> <!>`, 1), DeliverySettingsHeadingRow[FILENAME], [[27, 1], [28, 1, [[29, 2], [30, 2, [[31, 3]]]]]]);
...
var root_5$9 = add_locations(from_html(`<!> <!> <!>`, 1), DeliverySettingsPanel[FILENAME], []);
var root_2$c = add_locations(from_html(`<!> <!>`, 1), DeliverySettingsPanel[FILENAME], []);
var root_1$v = add_locations(from_html(`<!> <!> <!> <!> <!>`, 1), DeliverySettingsPanel[FILENAME], []);
...
var root$l = add_locations(from_html(`<!> <!>`, 1), MediaSettings[FILENAME], []);
...
var root_3$g = add_locations(from_html(`<p> </p>`), UrlPreview[FILENAME], [[47, 3]]);
var root_5$8 = add_locations(from_html(`<div><dt> </dt> <dd> </dd></div>`), UrlPreview[FILENAME], [[52, 5, [[53, 6], [54, 6]]]]);
var root_4$7 = add_locations(from_html(`<dl></dl>`), UrlPreview[FILENAME], [[50, 3]]);
var root_2$b = add_locations(from_html(`<!> <!>`, 1), UrlPreview[FILENAME], []);
...
var root_1$u = add_locations(from_html(`<div class="fixed-cta-block"><div class="buttons"><!> <!></div></div>`), Footer[FILENAME], [[66, 1, [[67, 2]]]]);
...
var root_2$a = add_locations(from_html(`<!> <!> <!> <!>`, 1), MediaPage[FILENAME], []);
var root$k = add_locations(from_html(`<!> <!> <!>`, 1), MediaPage[FILENAME], []);
...
var root_1$t = add_locations(from_html(`<!> <!> <!>`, 1), StoragePage[FILENAME], []);
...
var root_1$s = add_locations(from_html(`<img type="image/svg+xml"/>`), TabButton[FILENAME], [[36, 2]]);
var root_2$9 = add_locations(from_html(`<p> </p>`), TabButton[FILENAME], [[43, 2]]);
var root_3$f = add_locations(from_html(`<img class="checkmark" type="image/svg+xml"/>`), TabButton[FILENAME], [[46, 2]]);
var root$j = add_locations(from_html(`<a><!> <!> <!></a>`), TabButton[FILENAME], [[27, 0]]);
...
var root_1$r = add_locations(from_html(`<p class="radio-desc"></p>`), RadioButton[FILENAME], [[32, 1]]);
var root$i = add_locations(from_html(`<div><label><input type="radio"/> <!></label></div> <!>`, 1), RadioButton[FILENAME], [[25, 0, [[26, 1, [[27, 2]]]]]]);
...
var root$h = add_locations(from_html(`<p></p> <pre> </pre>`, 1), AccessKeysDefine[FILENAME], [[5, 0], [7, 0]]);
...
var root$g = add_locations(from_html(`<div class="btn-row"><!> <!> <!></div>`), BackNextButtonsRow[FILENAME], [[69, 0]]);
...
var root$f = add_locations(from_html(`<p></p> <pre> </pre>`, 1), KeyFileDefine[FILENAME], [[5, 0], [7, 0]]);
...
var root$e = add_locations(from_html(`<p></p> <pre> </pre>`, 1), UseServerRolesDefine[FILENAME], [[5, 0], [7, 0]]);
...
var root$d = add_locations(from_html(`<p></p> <label class="input-label"> </label> <input type="text" minlength="20" size="20"/> <label class="input-label"> </label> <input type="text" autocomplete="off" minlength="40" size="40"/>`, 1), AccessKeysEntry[FILENAME], [[27, 0], [29, 0], [30, 0], [41, 0], [42, 0]]);
...
var root$c = add_locations(from_html(`<p></p> <label class="input-label"> </label> <textarea rows="10"></textarea>`, 1), KeyFileEntry[FILENAME], [[18, 0], [20, 0], [21, 0]]);
...
var root_3$e = add_locations(from_html(`<p></p>`), StorageProviderSubPage[FILENAME], [[219, 3]]);
var root_8$5 = add_locations(from_html(`<p></p>`), StorageProviderSubPage[FILENAME], [[239, 4]]);
var root_5$7 = add_locations(from_html(`<!> <!>`, 1), StorageProviderSubPage[FILENAME], []);
var root_10$2 = add_locations(from_html(`<!> <!> <!>`, 1), StorageProviderSubPage[FILENAME], []);
var root_1$q = add_locations(from_html(`<!> <!> <!> <!> <!>`, 1), StorageProviderSubPage[FILENAME], []);
...
var root$b = add_locations(from_html(`<p> </p>`), Loading[FILENAME], [[5, 0]]);
...
var root_3$d = add_locations(from_html(`<!> <!>`, 1), BucketSettingsSubPage[FILENAME], []);
var root_11 = add_locations(from_html(`<option> </option>`), BucketSettingsSubPage[FILENAME], [[328, 10]]);
var root_10$1 = add_locations(from_html(`<div class="region flex-column"><label class="input-label" for="region"> <!></label> <select name="region" id="region"></select></div>`), BucketSettingsSubPage[FILENAME], [[322, 7, [[323, 8], [326, 8]]]]);
var root_9$3 = add_locations(from_html(`<div class="flex-row align-center row"><div class="new-bucket-details flex-column"><label class="input-label" for="bucket-name"> </label> <input type="text" id="bucket-name" name="bucket" minlength="3"/></div> <!></div>`), BucketSettingsSubPage[FILENAME], [[306, 5, [[307, 6, [[308, 7], [309, 7]]]]]]);
...
var root_19$2 = add_locations(from_html(`<li class="row nothing-found"><p> </p></li>`), BucketSettingsSubPage[FILENAME], [[381, 8, [[382, 9]]]]);
var root_15$1 = add_locations(from_html(`<ul class="bucket-list"><!></ul>`), BucketSettingsSubPage[FILENAME], [[360, 6]]);
var root_12$3 = add_locations(from_html(`<!> <!>`, 1), BucketSettingsSubPage[FILENAME], []);
var root_21$1 = add_locations(from_html(`<p class="input-error"> </p>`), BucketSettingsSubPage[FILENAME], [[389, 5]]);
var root_6$4 = add_locations(from_html(`<div class="flex-row align-center row radio-btns"><!> <!></div> <!> <!> <!>`, 1), BucketSettingsSubPage[FILENAME], [[300, 4]]);
var root_25 = add_locations(from_html(`<option> </option>`), BucketSettingsSubPage[FILENAME], [[419, 8]]);
var root_26$1 = add_locations(from_html(`<p class="input-error"> </p>`), BucketSettingsSubPage[FILENAME], [[430, 5]]);
...
var root_1$p = add_locations(from_html(`<!> <!> <!> <!>`, 1), BucketSettingsSubPage[FILENAME], []);
...
var root$a = add_locations(from_html(`<div><label class="toggle-label"><input type="checkbox"/> <!></label></div>`), Checkbox[FILENAME], [[19, 0, [[20, 1, [[21, 2]]]]]]);
...
var root_4$6 = add_locations(from_html(`<p></p> <p><!> <!></p>`, 1), SecuritySubPage[FILENAME], [[229, 4], [230, 4]]);
var root_5$6 = add_locations(from_html(`<p></p> <p><!> <!></p>`, 1), SecuritySubPage[FILENAME], [[232, 4], [233, 4]]);
var root_6$3 = add_locations(from_html(`<p></p> <p><!> <!></p>`, 1), SecuritySubPage[FILENAME], [[235, 4], [236, 4]]);
var root_7$2 = add_locations(from_html(`<p></p> <p><!> <!></p>`, 1), SecuritySubPage[FILENAME], [[238, 4], [239, 4]]);
var root_8$4 = add_locations(from_html(`<p></p> <p><!> <!></p>`, 1), SecuritySubPage[FILENAME], [[241, 4], [242, 4]]);
var root_9$2 = add_locations(from_html(`<div><!></div>`), SecuritySubPage[FILENAME], [[246, 3]]);
var root_2$8 = add_locations(from_html(`<!> <!>`, 1), SecuritySubPage[FILENAME], []);
...
var root_19$1 = add_locations(from_html(`<div><!></div>`), SecuritySubPage[FILENAME], [[281, 3]]);
var root_12$2 = add_locations(from_html(`<!> <!>`, 1), SecuritySubPage[FILENAME], []);
var root_1$o = add_locations(from_html(`<!> <!> <!>`, 1), SecuritySubPage[FILENAME], []);
...
var root_5$5 = add_locations(from_html(`<div class="row"><!> <p class="speed"></p> <p class="private-media"></p> <!></div>`), DeliveryPage[FILENAME], [[163, 6, [[171, 7], [172, 7]]]]);
var root_8$3 = add_locations(from_html(`<input type="text" class="cdn-name" id="cdn-name" name="cdn-name" minlength="4"/>`), DeliveryPage[FILENAME], [[183, 5]]);
var root_1$n = add_locations(from_html(`<!> <h2 class="page-title"> </h2> <div class="delivery-provider-settings-page wrapper"><!> <!> <!></div>`, 1), DeliveryPage[FILENAME], [[156, 1], [158, 1]]);
...
AssetsSettingsHeaderRow[FILENAME] = 'ui/pro/AssetsSettingsHeaderRow.svelte';

var root_1$m = add_locations(from_html(`<img alt="foo" class="svelte-zbh916"/> <div class="assets-details svelte-zbh916"><h3 class="svelte-zbh916"> </h3> <p class="console-details svelte-zbh916"> </p></div>`, 1), AssetsSettingsHeaderRow[FILENAME], [[7, 1], [8, 1, [[9, 2], [10, 2]]]]);

function AssetsSettingsHeaderRow($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, false, AssetsSettingsHeaderRow);
	...
	add_svelte_meta(
		() => PanelRow($$anchor, {
			header: true,
			class: 'assets',
			children: wrap_snippet(AssetsSettingsHeaderRow, ($$anchor, $$slotProps) => {
				...
				template_effect(() => {
					set_attribute(img, 'src', $urls().assets + 'img/icon/assets.svg');
					set_text(text, $strings().assets_panel_header);
					set_text(text_1, $strings().assets_panel_header_details);
				});
...
AssetsSettings[FILENAME] = 'ui/pro/AssetsSettings.svelte';

var root_1$l = add_locations(from_html(`<!> <!> <!> <!>`, 1), AssetsSettings[FILENAME], []);

function AssetsSettings($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, false, AssetsSettings);
	...
	const $assetsSettings = () => (
		validate_store(assetsSettings, 'assetsSettings'),
		store_get(assetsSettings, '$assetsSettings', $$stores)
	);
	...
	function validator(domain) {
		...
		if (strict_equals(domain.trim().length, 0)) {
			...
			message = $strings().domain_too_short;
		} else if (strict_equals(domain, $urls().home_domain)) {
	...
	add_svelte_meta(
		() => Panel($$anchor, {
			...
			class: 'assets-panel',
			get heading() {
				return $strings().assets_title;
			},
			helpKey: 'assets-pull',
			children: wrap_snippet(AssetsSettings, ($$anchor, $$slotProps) => {
				var fragment_1 = root_1$l();
				var node = first_child(fragment_1);

				add_svelte_meta(() => AssetsSettingsHeaderRow(node, {}), 'component', AssetsSettings, 37, 1, { componentTag: 'AssetsSettingsHeaderRow' });

				var node_1 = sibling(node, 2);

				add_svelte_meta(() => SettingsValidationStatusRow(node_1, { section: 'assets' }), 'component', AssetsSettings, 38, 1, { componentTag: 'SettingsValidationStatusRow' });
				...
				add_svelte_meta(
					() => SettingsPanelOption(node_2, {
						get heading() {
							return $strings().assets_rewrite_urls;
						},

						get description() {
							return $strings().assets_rewrite_urls_desc;
						},
						placeholder: 'assets.example.com',
						toggleName: 'rewrite-urls',
						textName: 'domain',
						get definedSettings() {
							return assetsDefinedSettings;
						},
						validator,
						get toggle() {
							return $assetsSettings()["rewrite-urls"];
						},

						set toggle($$value) {
							store_mutate(assetsSettings, untrack($assetsSettings)["rewrite-urls"] = $$value, untrack($assetsSettings));
						},

						get text() {
							return $assetsSettings()["domain"];
						},

						set text($$value) {
							store_mutate(assetsSettings, untrack($assetsSettings)["domain"] = $$value, untrack($assetsSettings));
						},
						$$legacy: true
					}),
					'component',
				...
				add_svelte_meta(
					() => SettingsPanelOption(node_3, {
						get heading() {
							return $strings().assets_force_https;
						},

						get description() {
							return $strings().assets_force_https_desc;
						},
						toggleName: 'force-https',
						get definedSettings() {
							return assetsDefinedSettings;
						...
						get toggle() {
							return $assetsSettings()["force-https"];
						},

						set toggle($$value) {
							store_mutate(assetsSettings, untrack($assetsSettings)["force-https"] = $$value, untrack($assetsSettings));
						},
						$$legacy: true
					}),
					'component',
...
var root_2$7 = add_locations(from_html(`<li class="svelte-1rikdvh"><img class="svelte-1rikdvh"/> <span> </span></li>`), Upsell[FILENAME], [[26, 4, [[27, 5], [28, 5]]]]);

var root_1$k = add_locations(from_html(`<div class="branding"></div> <div class="content svelte-1rikdvh"><div class="heading svelte-1rikdvh"><!></div> <div class="description svelte-1rikdvh"><!></div> <div class="benefits svelte-1rikdvh"></div> <div class="call-to-action svelte-1rikdvh"><!> <div class="note svelte-1rikdvh"><!></div></div></div>`, 1), Upsell[FILENAME], [
	[14, 1],
...
AssetsUpgrade[FILENAME] = 'ui/pro/AssetsUpgrade.svelte';

var root_1$j = add_locations(from_html(`<div> </div>`), AssetsUpgrade[FILENAME], [[26, 2]]);
var root_2$6 = add_locations(from_html(`<div></div>`), AssetsUpgrade[FILENAME], [[30, 2]]);
var root_3$c = add_locations(from_html(`<a class="button btn-lg btn-primary"><img alt="stars icon" style="margin-right: 5px;"/> </a>`), AssetsUpgrade[FILENAME], [[34, 2, [[35, 3]]]]);
var root_4$5 = add_locations(from_html(`<div></div>`), AssetsUpgrade[FILENAME], [[41, 2]]);
...
function AssetsUpgrade($$anchor, $$props) {
...

	{
		...
		const call_to_action_note = wrap_snippet(AssetsUpgrade, function ($$anchor) {
			validate_snippet_args(...arguments);

			var div_2 = root_4$5();

			html(div_2, () => $strings().assets_upsell_cta_note, true);
			reset(div_2);
			append($$anchor, div_2);
		});
...
AssetsPage[FILENAME] = 'ui/pro/AssetsPage.svelte';

var root_1$i = add_locations(from_html(`<!> <div class="assets-page wrapper"><!></div>`, 1), AssetsPage[FILENAME], [[31, 1]]);
var root$9 = add_locations(from_html(`<!> <!>`, 1), AssetsPage[FILENAME], []);
...
function AssetsPage($$anchor, $$props) {
	...
	const $enableAssets = () => (
		validate_store(enableAssets, 'enableAssets'),
		store_get(enableAssets, '$enableAssets', $$stores)
	);
	...
	add_svelte_meta(
		() => Page(node, {
			...
			children: wrap_snippet(AssetsPage, ($$anchor, $$slotProps) => {
				...
				{
					var consequent = ($$anchor) => {
						add_svelte_meta(() => AssetsSettings($$anchor, {}), 'component', AssetsPage, 33, 3, { componentTag: 'AssetsSettings' });
					};

					var alternate = ($$anchor) => {
						add_svelte_meta(() => AssetsUpgrade($$anchor, {}), 'component', AssetsPage, 35, 3, { componentTag: 'AssetsUpgrade' });
					};

					add_svelte_meta(
						() => if_block(node_2, ($$render) => {
							if ($enableAssets()) $$render(consequent); else $$render(alternate, -1);
						}),
						'if',
						AssetsPage,
						32,
...
ToolNotification[FILENAME] = 'ui/pro/ToolNotification.svelte';

var root_5$4 = add_locations(from_html(`<li></li>`), ToolNotification[FILENAME], [[63, 9]]);
var root_4$4 = add_locations(from_html(`<div class="item"><div class="summary"><div class="title"> <a> </a></div> <button class="dismiss"> </button></div> <ul class="detail"></ul></div>`), ToolNotification[FILENAME], [[53, 6, [[54, 7, [[55, 8, [[57, 9]]], [59, 8]]], [61, 7]]]]);
var root_3$b = add_locations(from_html(`<div class="details"></div>`), ToolNotification[FILENAME], [[51, 4]]);

function ToolNotification($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, ToolNotification);
	...
	async function dismissAll(tool_key, item) {
		(await track_reactivity_loss(api.delete("tools", {
			id: tool_key,
...

	{
		var consequent_1 = ($$anchor) => {
			{
				const details = wrap_snippet(ToolNotification, function ($$anchor) {
					validate_snippet_args(...arguments);
...

					{
						var consequent = ($$anchor) => {
							...
							add_svelte_meta(
								() => each(div, 21, () => $$props.notification.errors.details, index, ($$anchor, item, index$1) => {
									var div_1 = root_4$4();
									var div_2 = child(div_1);
									...
									add_svelte_meta(
										() => each(ul, 21, () => get(item).messages, index, ($$anchor, message, index, $$array) => {
											var li = root_5$4();

											html(li, () => get(message), true);
											reset(li);
											append($$anchor, li);
										}),
										'each',
									...
									template_effect(() => {
										set_text(text, `${index$1 + 1 + ". " + get(item).source_type_name} `);
										set_attribute(a, 'href', get(item).edit_url.url);
										set_text(text_1, `#${get(item).source_id ?? ''}`);
										set_text(text_2, $strings().dismiss);
									});

									delegated('click', button, function click(event) {
										event.preventDefault();
										dismissAll($$props.notification.errors.tool_key, get(item));
									});
		...
		var d = user_derived(() => $$props.notification.hasOwnProperty("class") && strict_equals($$props.notification.class, "tool-error") && $$props.notification.hasOwnProperty("errors"));
		...
		var alternate = ($$anchor) => {
			add_svelte_meta(
				() => Notification($$anchor, {
					...
					children: wrap_snippet(ToolNotification, ($$anchor, $$slotProps) => {
						var fragment_4 = comment();
						var node_2 = first_child(fragment_4);

						add_svelte_meta(() => snippet(node_2, () => $$props.children ?? noop), 'render', ToolNotification, 74, 2);
						append($$anchor, fragment_4);
					}),
					$$slots: { default: true }
				}),
...
var root$8 = add_locations(from_html(`<div><span></span></div>`), ProgressBar[FILENAME], [[62, 0, [[71, 1]]]]);
...
ToolRunningButtons[FILENAME] = 'ui/pro/ToolRunningButtons.svelte';

var root_1$h = add_locations(from_html(`<!> <!>`, 1), ToolRunningButtons[FILENAME], []);

function ToolRunningButtons($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, ToolRunningButtons);
		...
		var consequent_1 = ($$anchor) => {
			...
			add_svelte_meta(
				() => Button(node_1, {
					...
					children: wrap_snippet(ToolRunningButtons, ($$anchor, $$slotProps) => {
						var fragment_2 = comment();
						var node_2 = first_child(fragment_2);

						{
							var consequent = ($$anchor) => {
								...
								template_effect(() => set_text(text$1, $strings().resume_button));
								append($$anchor, text$1);
							};
							...
							var alternate = ($$anchor) => {
								...
								template_effect(() => set_text(text_1, $strings().pause_button));
								append($$anchor, text_1);
							};

							add_svelte_meta(
								() => if_block(node_2, ($$render) => {
									if (tool().is_paused) $$render(consequent); else $$render(alternate, -1);
								}),
								'if',
								ToolRunningButtons,
								33,
			...
			add_svelte_meta(
				() => Button(node_3, {
					...
					children: wrap_snippet(ToolRunningButtons, ($$anchor, $$slotProps) => {
						...
						template_effect(() => set_text(text_2, $strings().cancel_button));
						append($$anchor, text_2);
					}),
					$$slots: { default: true }
				}),
...
ToolPanel[FILENAME] = 'ui/pro/ToolPanel.svelte';

var root_4$3 = add_locations(from_html(`<h3></h3>`), ToolPanel[FILENAME], [[109, 4]]);
var root_5$3 = add_locations(from_html(`<h3></h3>`), ToolPanel[FILENAME], [[111, 4]]);
var root_6$2 = add_locations(from_html(`<h3></h3>`), ToolPanel[FILENAME], [[113, 4]]);
var root_7$1 = add_locations(from_html(`<h3></h3>`), ToolPanel[FILENAME], [[116, 3]]);
var root_2$5 = add_locations(from_html(`<img type="image/svg+xml"/> <!> <div class="buttons-right"><!></div>`, 1), ToolPanel[FILENAME], [[106, 2], [118, 2]]);
var root_20 = add_locations(from_html(`<h4><strong> </strong> <!></h4>`), ToolPanel[FILENAME], [[140, 5, [[141, 6]]]]);
var root_21 = add_locations(from_html(`<h4></h4>`), ToolPanel[FILENAME], [[145, 5]]);
var root_19 = add_locations(from_html(`<div class="status"><!> <!></div> <!>`, 1), ToolPanel[FILENAME], [[138, 3]]);
var root_23 = add_locations(from_html(`<p class="desc"></p>`), ToolPanel[FILENAME], [[160, 3]]);
var root_26 = add_locations(from_html(`<p><a> </a></p>`), ToolPanel[FILENAME], [[165, 5, [[166, 6]]]]);
var root_22 = add_locations(from_html(`<!> <!>`, 1), ToolPanel[FILENAME], []);
var root_1$g = add_locations(from_html(`<!> <!> <!>`, 1), ToolPanel[FILENAME], []);

function ToolPanel($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, ToolPanel);

	const $running = () => (
		validate_store(running, 'running'),
		store_get(running, '$running', $$stores)
	);

	const $toolsLocked = () => (
		validate_store(toolsLocked, 'toolsLocked'),
		store_get(toolsLocked, '$toolsLocked', $$stores)
	);

	const $bucket_writable = () => (
		validate_store(bucket_writable, 'bucket_writable'),
		store_get(bucket_writable, '$bucket_writable', $$stores)
	);
	...
	let showTotal = tag(user_derived(() => !!tool().hasOwnProperty("total_progress")), 'showTotal');

	let initial = tag(user_derived(() => !!(get(showTotal) && tool().total_progress < 1)), 'initial');
	let partialComplete = tag(user_derived(() => !!(get(showTotal) && tool().total_progress > 0 && tool().total_progress < 100)), 'partialComplete');
	let complete = tag(user_derived(() => !!(get(showTotal) && !get(initial) && !get(partialComplete))), 'complete');

	// In progress related variables.
	let isRunning = tag(user_derived(() => !!($running() && strict_equals($running(), tool().id))), 'isRunning');

	let starting = tag(user_derived(() => !!(get(isRunning) && tool().progress < 1 && !tool().is_paused)), 'starting');
	...
	let disabled = tag(user_derived(() => $running() && strict_equals($running(), tool().id, false) || tool().is_processing && tool().is_paused || tool().is_cancelled || $toolsLocked()), 'disabled');

	let disabled_bucket_access = tag(user_derived(() => tool().requires_bucket_access && !$bucket_writable()), 'disabled_bucket_access');
	...
	let percentComplete = tag(user_derived(() => getPercentComplete(tool(), get(isRunning), get(showTotal))), 'percentComplete');
	...
	let icon = tag(user_derived(() => getIcon(tool(), get(isRunning))), 'icon');
	...
	let relatedTools = tag(user_derived(() => getRelatedTools(tool())), 'relatedTools');
	...
	add_svelte_meta(
		() => Panel($$anchor, {
			multi: true,
			class: 'tools-panel',
			children: wrap_snippet(ToolPanel, ($$anchor, $$slotProps) => {
					...
					() => PanelRow(node, {
						...
						children: wrap_snippet(ToolPanel, ($$anchor, $$slotProps) => {
...

							{
								var consequent_2 = ($$anchor) => {
...

									{
										...
										var consequent_1 = ($$anchor) => {
											...
											html(h3_1, () => tool().title_partial_complete, true);
											reset(h3_1);
											append($$anchor, h3_1);
										};
										...
										var alternate = ($$anchor) => {
											...
											html(h3_2, () => tool().title_complete, true);
											reset(h3_2);
											append($$anchor, h3_2);
										};
										...
										add_svelte_meta(
											() => if_block(node_2, ($$render) => {
												if (get(initial)) $$render(consequent); else if (get(partialComplete)) $$render(consequent_1, 1); else $$render(alternate, -1);
											}),
											'if',
											ToolPanel,
											108,
								...
								add_svelte_meta(
									() => if_block(node_1, ($$render) => {
										if (get(showTotal)) $$render(consequent_2); else $$render(alternate_1, -1);
									}),
									'if',
									ToolPanel,
									107,
...

							{
								var consequent_3 = ($$anchor) => {
									add_svelte_meta(
										...
										120,
										4,
										{ componentTag: 'ToolRunningButtons' }
									);
								};
								...
								var alternate_3 = ($$anchor) => {
...

									{
											...
											add_svelte_meta(
												() => Button($$anchor, {
													...
													children: wrap_snippet(ToolPanel, ($$anchor, $$slotProps) => {
														...
														html(node_5, () => get(partialComplete) ? tool().button_partial_complete : tool().button);
														append($$anchor, fragment_7);
													}),
													$$slots: { default: true }
												}),
										...
										var consequent_6 = ($$anchor) => {
											{
												let $0 = user_derived(() => get(disabled) ? $strings().disabled_tool_button : "");
												...
												add_svelte_meta(
													() => Button($$anchor, {
														...
														children: wrap_snippet(ToolPanel, ($$anchor, $$slotProps) => {
															...
															html(node_7, () => tool().button_partial_complete);
															append($$anchor, fragment_11);
														}),
														$$slots: { default: true }
													}),
										...
										add_svelte_meta(
											() => if_block(node_4, ($$render) => {
												if (get(complete)) $$render(consequent_4); else if (get(disabled_bucket_access)) $$render(consequent_5, 1); else if (get(initial)) $$render(consequent_6, 2); else if (get(partialComplete)) $$render(consequent_7, 3); else $$render(alternate_2, -1);
											}),
											'if',
											ToolPanel,
											122,
								...
								add_svelte_meta(
									() => if_block(node_3, ($$render) => {
										if (get(isRunning)) $$render(consequent_3); else $$render(alternate_3, -1);
									}),
									'if',
									ToolPanel,
									119,
							...
							template_effect(() => {
								set_attribute(img, 'src', get(icon));
								set_attribute(img, 'alt', tool().title);
							});
...

				{
					var consequent_9 = ($$anchor) => {
						add_svelte_meta(
							() => PanelRow($$anchor, {
								class: 'body flex-row show-progress',
								children: wrap_snippet(ToolPanel, ($$anchor, $$slotProps) => {
									var fragment_15 = root_19();
									var div_1 = first_child(fragment_15);
...

									{
										var consequent_8 = ($$anchor) => {
											...
											html(node_11, () => tool().status_description
												? " " + tool().status_description
												: " " + tool().busy_description);
											...
											template_effect(
												...
												[
													() => getPercentComplete(tool(), get(isRunning), get(showTotal)),
													() => numToString(tool().queue.processed),
													() => numToString(tool().queue.total)
												]
											);
										...
										var alternate_4 = ($$anchor) => {
											...
											html(h4_1, () => tool().progress_description, true);
											reset(h4_1);
											append($$anchor, h4_1);
										};
										...
										add_svelte_meta(
											() => if_block(node_10, ($$render) => {
												if (get(isRunning)) $$render(consequent_8); else $$render(alternate_4, -1);
											}),
											'if',
											ToolPanel,
											139,
									...
									add_svelte_meta(() => snippet(node_12, () => $$props.status_right ?? noop, () => ({ isRunning: get(isRunning) })), 'render', ToolPanel, 147, 4);
									reset(div_1);

									var node_13 = sibling(div_1, 2);

									{
										let $0 = user_derived(() => !get(isRunning) && get(showTotal)
											? "(" + numToString(tool().total_processed) + "/" + numToString(tool().total_items) + ")"
											: "");
					...
					add_svelte_meta(
						() => if_block(node_9, ($$render) => {
							if (get(complete) || get(partialComplete) || get(isRunning)) $$render(consequent_9);
						}),
						'if',
						ToolPanel,
						136,
...

				{
					var consequent_11 = ($$anchor) => {
...

						{
								...
								add_svelte_meta(
									() => PanelRow($$anchor, {
										...
										children: wrap_snippet(ToolPanel, ($$anchor, $$slotProps) => {
											...
											add_svelte_meta(
												() => each(node_17, 17, () => [...get(relatedTools)], index, ($$anchor, $$item) => {
													var $$array = user_derived(() => to_array(get($$item), 2));
													let key = () => get($$array)[0];

													key();

													let relatedTool = () => get($$array)[1];
													...
													template_effect(() => {
														set_attribute(a, 'href', $urls().settings);
														set_attribute(a, 'title', relatedTool().more_info);
														set_text(text_2, relatedTool().title);
													});

													delegated('click', a, function click(event) {
														event.preventDefault();
														handleStartTool(relatedTool());
													});
							...
							add_svelte_meta(
								() => if_block(node_16, ($$render) => {
									if (!get(disabled) && get(relatedTools).size > 0) $$render(consequent_10);
								}),
								'if',
								ToolPanel,
								162,
					...
					add_svelte_meta(
						() => if_block(node_14, ($$render) => {
							if (!get(complete) && !get(partialComplete) && !get(isRunning)) $$render(consequent_11);
						}),
						'if',
						ToolPanel,
						158,
...
NoTools[FILENAME] = 'ui/pro/NoTools.svelte';

var root_1$f = add_locations(from_html(`<div> </div>`), NoTools[FILENAME], [[31, 2]]);
var root_2$4 = add_locations(from_html(`<div></div>`), NoTools[FILENAME], [[35, 2]]);

function NoTools($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, false, NoTools);
	...
	{
		const heading = wrap_snippet(NoTools, function ($$anchor) {
			validate_snippet_args(...arguments);
			...
			reset(div);
			template_effect(() => set_text(text, $strings().no_tools_header));
			append($$anchor, div);
		});

		const description = wrap_snippet(NoTools, function ($$anchor) {
			validate_snippet_args(...arguments);

			var div_1 = root_2$4();

			html(div_1, () => $strings().no_tools_description, true);
			reset(div_1);
			append($$anchor, div_1);
		});
		...
		add_svelte_meta(
			() => Upsell($$anchor, {
				...
				heading,
				description,
				$$slots: { heading: true, description: true }
			}),
			'component',
			NoTools,
			29,
...
ToolsPage[FILENAME] = 'ui/pro/ToolsPage.svelte';

var root_1$e = add_locations(from_html(`<!> <h2 class="page-title"> </h2> <div class="tools-page wrapper"></div>`, 1), ToolsPage[FILENAME], [[27, 1], [29, 1]]);
			...
			children: wrap_snippet(ToolsPage, ($$anchor, $$slotProps) => {
				...
				add_svelte_meta(
					() => each(
						div,
						5,
						() => Object.values($tools()).filter((tool) => tool.render),
						(tool) => tool.id,
						($$anchor, tool) => {
							add_svelte_meta(
								() => ToolPanel($$anchor, {
								...
								31,
								3,
								{ componentTag: 'ToolPanel' }
							);
						},
						($$anchor) => {
							add_svelte_meta(() => NoTools($$anchor, {}), 'component', ToolsPage, 33, 3, { componentTag: 'NoTools' });
						}
					),
					'each',
					ToolsPage,
...
LicencePage[FILENAME] = 'ui/pro/LicencePage.svelte';

var root_2$3 = add_locations(from_html(`<label for="licence-key" class="screen-reader-text"> </label> <input id="licence-key" type="text" class="licence-field disabled" name="licence" disabled=""/> <!>`, 1), LicencePage[FILENAME], [[76, 3], [77, 3]]);
var root_6$1 = add_locations(from_html(`<label for="enter-licence-key" class="screen-reader-text"> </label> <input id="enter-licence-key" type="text" class="licence-field" name="licence" minlength="4"/> <!>`, 1), LicencePage[FILENAME], [[91, 3], [92, 3]]);
var root_1$d = add_locations(from_html(`<!> <h2 class="page-title"> </h2> <div><!></div>`, 1), LicencePage[FILENAME], [[72, 1], [74, 1]]);

function LicencePage($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, LicencePage);
	...
	const $licence = () => (
		validate_store(licence, 'licence'),
		store_get(licence, '$licence', $$stores)
	);
	 ...
	 */
	/** @type {Props} */
	let name = prop($$props, 'name', 3, "licence");
	...
	async function handleActivateLicence(event) {
		const result = (await track_reactivity_loss(api.post("licences", { licence: get(value) })))();

		(await track_reactivity_loss(updateLicenceInfo(result)))();
	}
	...
	async function handleRemoveLicence(event) {
		...
		const result = (await track_reactivity_loss(api.delete("licences")))();
	...
	async function updateLicenceInfo(response) {
		if (response.hasOwnProperty("licences")) {
			config.update((currentConfig) => {
				return { ...currentConfig, licences: response.licences };
			});
		}
	...
	add_svelte_meta(
		() => Page($$anchor, {
			...
			children: wrap_snippet(LicencePage, ($$anchor, $$slotProps) => {
...

				{
					var consequent_1 = ($$anchor) => {
						...
						{
							var consequent = ($$anchor) => {
								add_svelte_meta(() => DefinedInWPConfig($$anchor, { defined: true }), 'component', LicencePage, 86, 4, { componentTag: 'DefinedInWPConfig' });
							};
								...
								add_svelte_meta(
									() => Button($$anchor, {
										...
										children: wrap_snippet(LicencePage, ($$anchor, $$slotProps) => {
											...
											template_effect(() => set_text(text_2, $strings().remove_licence));
											append($$anchor, text_2);
										}),
										$$slots: { default: true }
									}),
							...
							add_svelte_meta(
								() => if_block(node_2, ($$render) => {
									if ($licence().is_defined) $$render(consequent); else $$render(alternate, -1);
								}),
								'if',
								LicencePage,
								85,
						...
						template_effect(() => {
							set_text(text_1, $strings().licence_title);
							set_value(input, $licence().masked_licence);
						});
					...
					var alternate_1 = ($$anchor) => {
						...
						var label_1 = first_child(fragment_6);
						...
						action(input_1, ($$node) => autofocus?.($$node));

						var node_3 = sibling(input_1, 2);

						{
							let $0 = user_derived(() => strict_equals(get(value).length, 0));
							...
							add_svelte_meta(
								() => Button(node_3, {
									...
									children: wrap_snippet(LicencePage, ($$anchor, $$slotProps) => {
										...
										template_effect(() => set_text(text_4, $strings().activate_licence));
										append($$anchor, text_4);
									}),
									$$slots: { default: true }
								}),
						...
						template_effect(() => {
							set_text(text_3, $strings().enter_licence_key);
							set_attribute(input_1, 'placeholder', $strings().enter_licence_key);
						});
					...
					add_svelte_meta(
						() => if_block(node_1, ($$render) => {
							if ($licence().is_set) $$render(consequent_1); else $$render(alternate_1, -1);
						}),
						'if',
						LicencePage,
						75,
				...
				template_effect(() => {
					set_text(text$1, $strings().licence_title);
					classes = set_class(div, 1, 'licence-page wrapper', null, classes, { defined: $licence().is_set && $licence().is_defined });
				});
...
var root_2$2 = add_locations(from_html(`<h2 class="page-title"> </h2>`), SupportPage[FILENAME], [[39, 2]]);
var root_4$2 = add_locations(from_html(`<div class="lite-support"><p></p> <p></p> <p></p> <p></p></div>`), SupportPage[FILENAME], [[50, 5, [[51, 6], [52, 6], [53, 6], [54, 6]]]]);

var root_1$c = add_locations(from_html(`<!> <!> <div class="support-page wrapper"><!> <div class="columns"><div class="support-form"><!> <div class="diagnostic-info"><hr/> <h2 class="page-title"> </h2> <pre> </pre> <a class="button btn-md btn-outline"> </a></div></div> <!></div></div>`, 1), SupportPage[FILENAME], [
	[
		41,
		1,
		[
...
DocumentationSidebar[FILENAME] = 'ui/pro/DocumentationSidebar.svelte';

var root_2$1 = add_locations(from_html(`<a class="link" target="_blank"> </a>`), DocumentationSidebar[FILENAME], [[10, 3]]);
var root_1$b = add_locations(from_html(`<div class="documentation"><h3> </h3> <!></div>`), DocumentationSidebar[FILENAME], [[7, 1, [[8, 2]]]]);

function DocumentationSidebar($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, false, DocumentationSidebar);

	const $documentation = () => (
		validate_store(documentation, 'documentation'),
		store_get(documentation, '$documentation', $$stores)
	);
...

	{
		var consequent = ($$anchor) => {
			...
			add_svelte_meta(
				() => each(node_1, 1, $documentation, index, ($$anchor, item) => {
					var a = root_2$1();
					var text_1 = child(a, true);
			...
			template_effect(() => set_text(text, $strings().documentation_title));
			append($$anchor, div);
		};

		add_svelte_meta(
			() => if_block(node, ($$render) => {
				if ($documentation().length) $$render(consequent);
			}),
			'if',
			DocumentationSidebar,
			6,
...
SupportForm[FILENAME] = 'ui/pro/SupportForm.svelte';

var root_1$a = add_locations(from_html(`<option> </option>`), SupportForm[FILENAME], [[124, 2]]);

var root$7 = add_locations(from_html(`<label for="email" class="input-label">From</label> <select name="email" id="email"><!><option> </option></select> <p class="note"></p> <input type="text" id="subject" name="subject" minlength="4"/> <textarea id="message" name="message" rows="8"></textarea> <div class="actions"><div class="checkbox"><label for="include-diagnostics"><input type="checkbox" id="include-diagnostics" name="include-diagnostics"/> </label></div> <!></div> <p class="note first"> </p> <p class="note"></p>`, 1), SupportForm[FILENAME], [
	[121, 0],
	[122, 0, [[126, 1]]],
	[128, 0],
	[129, 0],
...
function SupportForm($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, SupportForm);
	...
	let subject = tag(state(""), 'subject');
	let message = tag(state(""), 'message');
	let includeDiagnostics = tag(state(true), 'includeDiagnostics');
	...
	function getDisabledReason(email, subject, message) {
		...
		if (!email || !subject || !message) {
			// TODO: Get translatable string from strings store.
	...
	let disabledReason = tag(user_derived(() => getDisabledReason(get(email), get(subject), get(message))), 'disabledReason');
	...
	async function submitSupportRequest(event) {
		...
		formData.append("subject", get(subject));
		formData.append("message", get(message));
		...
		try {
			response = (await track_reactivity_loss(fetch($licence().support_url, { method: "POST", body: formData })))();
		} catch(error) {
		...
		const json = (await track_reactivity_loss(response.json()))();
		...
		if (json.hasOwnProperty("success") && strict_equals(json.success, 1)) {
			notifications.add({
				id: "support-send-email-response",
				type: "success",
				dismissible: true,
	...
	add_svelte_meta(
		() => each(node, 1, () => $licence().support_email_addresses, index, ($$anchor, supportEmail) => {
			var option = root_1$a();
			...
			template_effect(() => {
				set_text(text, get(supportEmail));

				if (option_value !== (option_value = get(supportEmail))) {
					option.value = (option.__value = get(supportEmail)) ?? '';
				}
			});
	...
	var option_1 = sibling(node);
	var text_1 = child(option_1);
	option_1.value = option_1.__value = '';

	var p = sibling(select, 2);

	html(p, () => $strings().email_note, true);
	...
	var text_2 = sibling(input_1, 1, true);
	...
	add_svelte_meta(
		() => Button(node_1, {
			...
			children: wrap_snippet(SupportForm, ($$anchor, $$slotProps) => {
				next();

				var text_3 = text();

				template_effect(() => set_text(text_3, $strings().send_email));
				append($$anchor, text_3);
			}),
			$$slots: { default: true }
		}),
	...
	html(p_2, () => $strings().email_instead, true);

	template_effect(() => {
		set_text(text_1, $strings().select_email);
		set_attribute(input, 'placeholder', $strings().email_subject_placeholder);
		set_attribute(textarea, 'placeholder', $strings().email_message_placeholder);
		set_text(text_2, $strings().attach_diagnostics);
		set_text(text_4, $strings().having_trouble);
	});
...
SupportPage_1[FILENAME] = 'ui/pro/SupportPage.svelte';

var root_3$a = add_locations(from_html(`<p class="licence-type"></p>`), SupportPage_1[FILENAME], [[42, 4]]);
var root_8$2 = add_locations(from_html(`<p></p>`), SupportPage_1[FILENAME], [[57, 5]]);
var root_12$1 = add_locations(from_html(`<p> <a href="/license"> </a></p> <p> </p>`, 1), SupportPage_1[FILENAME], [[72, 4, [[74, 5]]], [78, 4]]);

function SupportPage_1($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, SupportPage_1);
	...
	let licenceError = tag(user_derived(() => getLicenceError($licence())), 'licenceError');
	var $$exports = { ...legacy_api() };
	var fragment = comment();
	var node = first_child(fragment);

	{
		var consequent_1 = ($$anchor) => {
...

			{
				var consequent = ($$anchor) => {
					{
						const header = wrap_snippet(SupportPage_1, function ($$anchor) {
							validate_snippet_args(...arguments);

							var p = root_3$a();

							html(p, () => $licence().your_active_licence, true);
							reset(p);
							append($$anchor, p);
						});

						const content = wrap_snippet(SupportPage_1, function ($$anchor) {
							validate_snippet_args(...arguments);
							add_svelte_meta(() => SupportForm($$anchor, {}), 'component', SupportPage_1, 46, 4, { componentTag: 'SupportForm' });
						});

						const footer = wrap_snippet(SupportPage_1, function ($$anchor) {
							validate_snippet_args(...arguments);
							add_svelte_meta(() => DocumentationSidebar($$anchor, {}), 'component', SupportPage_1, 50, 4, { componentTag: 'DocumentationSidebar' });
						});
						...
						add_svelte_meta(
							() => SupportPage($$anchor, {
								...
								get title() {
									return $strings().email_support_title;
								},
				...
				var alternate = ($$anchor) => {
					{
						const content = wrap_snippet(SupportPage_1, function ($$anchor) {
							...
							add_svelte_meta(
								() => Notification($$anchor, {
									warning: true,
									inline: true,
									children: wrap_snippet(SupportPage_1, ($$anchor, $$slotProps) => {
										var p_1 = root_8$2();

										html(p_1, () => get(licenceError), true);
										reset(p_1);
										append($$anchor, p_1);
									}),
									$$slots: { default: true }
						...
						const footer = wrap_snippet(SupportPage_1, function ($$anchor) {
							validate_snippet_args(...arguments);
							add_svelte_meta(() => DocumentationSidebar($$anchor, {}), 'component', SupportPage_1, 64, 4, { componentTag: 'DocumentationSidebar' });
						});
						...
						add_svelte_meta(
							() => SupportPage($$anchor, {
								...
								content,
								footer,
								$$slots: { content: true, footer: true }
							}),
							'component',
							SupportPage_1,
							54,
				...
				add_svelte_meta(
					() => if_block(node_1, ($$render) => {
						if ($licence().is_valid && strict_equals(get(licenceError).length, 0)) $$render(consequent); else $$render(alternate, -1);
					}),
					'if',
					SupportPage_1,
					39,
		...
		var alternate_1 = ($$anchor) => {
			{
				const content = wrap_snippet(SupportPage_1, function ($$anchor) {
					...
					add_svelte_meta(
						() => Notification($$anchor, {
							...
							inline: true,
							children: wrap_snippet(SupportPage_1, ($$anchor, $$slotProps) => {
								var fragment_10 = root_12$1();
								var p_2 = first_child(fragment_10);
								var text = child(p_2);
								var a = sibling(text);
								var text_1 = child(a, true);
								...
								template_effect(() => {
									set_text(text, `${$strings().licence_not_entered ?? ''} `);
									set_text(text_1, $strings().please_enter_licence);
									set_text(text_2, $strings().once_licence_entered);
								});
				...
				const footer = wrap_snippet(SupportPage_1, function ($$anchor) {
					validate_snippet_args(...arguments);
					add_svelte_meta(() => DocumentationSidebar($$anchor, {}), 'component', SupportPage_1, 83, 3, { componentTag: 'DocumentationSidebar' });
				});
...
UpdateObjectACLsPromptSubPage[FILENAME] = 'ui/pro/UpdateObjectACLsPromptSubPage.svelte';

var root_3$9 = add_locations(from_html(`<p></p>`), UpdateObjectACLsPromptSubPage[FILENAME], [[56, 3]]);
var root_1$9 = add_locations(from_html(`<!> <!>`, 1), UpdateObjectACLsPromptSubPage[FILENAME], []);

function UpdateObjectACLsPromptSubPage($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, UpdateObjectACLsPromptSubPage);
	 ...
	 */
	async function handleNext() {
		(await track_reactivity_loss(tools.start(tool)))();
		$$props.onRouteEvent({ event: "next", default: "/" });
	}
	...
	add_svelte_meta(
		() => SubPage($$anchor, {
			...
			children: wrap_snippet(UpdateObjectACLsPromptSubPage, ($$anchor, $$slotProps) => {
...
CopyBucketsPromptSubPage[FILENAME] = 'ui/pro/CopyBucketsPromptSubPage.svelte';

var root_3$8 = add_locations(from_html(`<p></p>`), CopyBucketsPromptSubPage[FILENAME], [[56, 3]]);
var root_1$8 = add_locations(from_html(`<!> <!>`, 1), CopyBucketsPromptSubPage[FILENAME], []);

function CopyBucketsPromptSubPage($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, CopyBucketsPromptSubPage);
	...
	add_svelte_meta(
		() => SubPage($$anchor, {
			...
			children: wrap_snippet(CopyBucketsPromptSubPage, ($$anchor, $$slotProps) => {
...
MoveObjectsPromptPage[FILENAME] = 'ui/pro/MoveObjectsPromptPage.svelte';

var root_3$7 = add_locations(from_html(`<p></p>`), MoveObjectsPromptPage[FILENAME], [[72, 3]]);
var root_5$2 = add_locations(from_html(`<p></p>`), MoveObjectsPromptPage[FILENAME], [[86, 3]]);
var root_1$7 = add_locations(from_html(`<!> <!> <!> <!>`, 1), MoveObjectsPromptPage[FILENAME], []);

function MoveObjectsPromptPage($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, MoveObjectsPromptPage);
	 ...
	 */
	/** @type {Props} */
	let name = prop($$props, 'name', 3, "move-objects");
	...
	let movePublicObjects = tag(state(false), 'movePublicObjects');
	let movePrivateObjects = tag(state(true), 'movePrivateObjects');
	let nextDisabled = tag(user_derived(() => $settingsLocked() || !get(movePublicObjects) && !get(movePrivateObjects)), 'nextDisabled');
	...
	async function handleNext() {
		...
		if (!get(movePublicObjects) || !get(movePrivateObjects)) {
			tool = get(movePublicObjects) ? movePublicObjectsTool : movePrivateObjectsTool;
		}
	...
	add_svelte_meta(
		() => Page($$anchor, {
			...
			children: wrap_snippet(MoveObjectsPromptPage, ($$anchor, $$slotProps) => {
				...
				add_svelte_meta(
					() => Panel(node_1, {
						class: 'toggle-header',
						get heading() {
							return movePublicObjectsTool.name;
						},
						toggleName: 'move-public-objects',
						get helpURL() {
							return movePublicObjectsTool.doc_url;
						},

						get helpDesc() {
							return movePublicObjectsTool.doc_desc;
						},
						multi: true,
						get toggle() {
							return get(movePublicObjects);
						},

						set toggle($$value) {
							set(movePublicObjects, $$value, true);
						},
							...
							add_svelte_meta(
								() => PanelRow($$anchor, {
									...
									children: wrap_snippet(MoveObjectsPromptPage, ($$anchor, $$slotProps) => {
										...
										html(p, () => movePublicObjectsTool.prompt, true);
										reset(p);
										append($$anchor, p);
									}),
									$$slots: { default: true }
				...
				add_svelte_meta(
					() => Panel(node_2, {
						class: 'toggle-header',
						get heading() {
							return movePrivateObjectsTool.name;
						},
						toggleName: 'move-private-objects',
						get helpURL() {
							return movePrivateObjectsTool.doc_url;
						},

						get helpDesc() {
							return movePrivateObjectsTool.doc_desc;
						},
						multi: true,
						get toggle() {
							return get(movePrivateObjects);
						},

						set toggle($$value) {
							set(movePrivateObjects, $$value, true);
						},
							...
							add_svelte_meta(
								() => PanelRow($$anchor, {
									...
									children: wrap_snippet(MoveObjectsPromptPage, ($$anchor, $$slotProps) => {
										...
										html(p_1, () => movePrivateObjectsTool.prompt, true);
										reset(p_1);
										append($$anchor, p_1);
									}),
									$$slots: { default: true }
				...
				add_svelte_meta(
					() => BackNextButtonsRow(node_3, {
						onSkip: handleSkip,
						onNext: handleNext,
						get nextText() {
							return moveObjectsTool.button;
						},
						skipVisible: true,
						get nextDisabled() {
							return get(nextDisabled);
...
MovePublicObjectsPromptPage[FILENAME] = 'ui/pro/MovePublicObjectsPromptPage.svelte';

var root_3$6 = add_locations(from_html(`<p></p>`), MovePublicObjectsPromptPage[FILENAME], [[56, 3]]);
var root_1$6 = add_locations(from_html(`<!> <!> <!>`, 1), MovePublicObjectsPromptPage[FILENAME], []);

function MovePublicObjectsPromptPage($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, MovePublicObjectsPromptPage);
	 ...
	 */
	/** @type {Props} */
	let name = prop($$props, 'name', 3, "move-public-objects");
	...
	add_svelte_meta(
		() => Page($$anchor, {
			...
			children: wrap_snippet(MovePublicObjectsPromptPage, ($$anchor, $$slotProps) => {
...
MovePrivateObjectsPromptPage[FILENAME] = 'ui/pro/MovePrivateObjectsPromptPage.svelte';

var root_3$5 = add_locations(from_html(`<p></p>`), MovePrivateObjectsPromptPage[FILENAME], [[56, 3]]);
var root_1$5 = add_locations(from_html(`<!> <!> <!>`, 1), MovePrivateObjectsPromptPage[FILENAME], []);

function MovePrivateObjectsPromptPage($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, MovePrivateObjectsPromptPage);
	 ...
	 */
	/** @type {Props} */
	let name = prop($$props, 'name', 3, "move-private-objects");
	...
	add_svelte_meta(
		() => Page($$anchor, {
			...
			children: wrap_snippet(MovePrivateObjectsPromptPage, ($$anchor, $$slotProps) => {
...
RemoveLocalFilesPromptPage[FILENAME] = 'ui/pro/RemoveLocalFilesPromptPage.svelte';

var root_3$4 = add_locations(from_html(`<p></p>`), RemoveLocalFilesPromptPage[FILENAME], [[56, 3]]);
var root_1$4 = add_locations(from_html(`<!> <!> <!>`, 1), RemoveLocalFilesPromptPage[FILENAME], []);

function RemoveLocalFilesPromptPage($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, RemoveLocalFilesPromptPage);
	 ...
	 */
	/** @type {Props} */
	let name = prop($$props, 'name', 3, "remove-local-files");
	...
	add_svelte_meta(
		() => Page($$anchor, {
			...
			children: wrap_snippet(RemoveLocalFilesPromptPage, ($$anchor, $$slotProps) => {
...
UploaderPromptPage[FILENAME] = 'ui/pro/UploaderPromptPage.svelte';

var root_3$3 = add_locations(from_html(`<p></p>`), UploaderPromptPage[FILENAME], [[56, 3]]);
var root_1$3 = add_locations(from_html(`<!> <!> <!>`, 1), UploaderPromptPage[FILENAME], []);

function UploaderPromptPage($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, UploaderPromptPage);
	 ...
	 */
	/** @type {Props} */
	let name = prop($$props, 'name', 3, "uploader");
	...
	add_svelte_meta(
		() => Page($$anchor, {
			...
			children: wrap_snippet(UploaderPromptPage, ($$anchor, $$slotProps) => {
...
DownloaderPromptPage[FILENAME] = 'ui/pro/DownloaderPromptPage.svelte';

var root_3$2 = add_locations(from_html(`<p></p>`), DownloaderPromptPage[FILENAME], [[56, 3]]);
var root_1$2 = add_locations(from_html(`<!> <!> <!>`, 1), DownloaderPromptPage[FILENAME], []);

function DownloaderPromptPage($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, DownloaderPromptPage);
	 ...
	 */
	/** @type {Props} */
	let name = prop($$props, 'name', 3, "downloader");
	...
	add_svelte_meta(
		() => Page($$anchor, {
			...
			children: wrap_snippet(DownloaderPromptPage, ($$anchor, $$slotProps) => {
...
function addPages( enabledTools ) {
	pages.add(
		{
			position: 10,
			name: "assets",
	...
	pages.add(
		{
			position: 90,
			name: "licence",
			title: () => get$1( strings ).licence_tab_title,
			nav: true,
			route: "/license",
	...
	if ( enabledTools.hasOwnProperty( "update_acls" ) ) {
		const updateACLs = {
			...
			enabled: () => {
				// Nothing to update?
				if (
					!get$1( counts ).hasOwnProperty( "offloaded" ) ||
					get$1( counts ).offloaded < 1 ||
					!get$1( current_settings ).hasOwnProperty( "bucket" ) ) {
					return false;
				}

				// Current Storage Provider never allows ACLs to be disabled.
				if ( get$1( storage_provider ).requires_acls ) {
					return false;
				}

				// If either Block All Public Access or Object Ownership turned on,
				// we should not update ACLs.
				if ( get$1( bapa ) || get$1( ooe ) ) {
					return false;
				}

				// Update ACLs if BAPA just turned off.
				if (
					get$1( storage_provider ).block_public_access_supported &&
					get$1( current_settings ).hasOwnProperty( "block-public-access" ) &&
					updateACLs.blockPublicAccess !== get$1( current_settings )[ "block-public-access" ]
				) {
					return true;
				}
				...
				if (
					get$1( storage_provider ).object_ownership_supported &&
					get$1( current_settings ).hasOwnProperty( "object-ownership-enforced" ) &&
					updateACLs.objectOwnershipEnforced !== get$1( current_settings )[ "object-ownership-enforced" ]
				) {
					return true;
				}
			...
			isNextRoute: ( data ) => {
				if (
					!get$1( licence ).hasOwnProperty( "is_valid" ) ||
					!get$1( licence ).is_valid ||
					!updateACLs.enabled()
				) {
					return false;
				}
				...
				return get$1( location$1 ) === "/storage/security";
			},
			blockPublicAccess: get$1( current_settings ).hasOwnProperty( "bucket" ) && get$1( current_settings ).hasOwnProperty( "block-public-access" ) ? get$1( current_settings )[ "block-public-access" ] : false,
			objectOwnershipEnforced: get$1( current_settings ).hasOwnProperty( "bucket" ) && get$1( current_settings ).hasOwnProperty( "object-ownership-enforced" ) ? get$1( current_settings )[ "object-ownership-enforced" ] : false,
	...
	if ( enabledTools.hasOwnProperty( "copy_buckets" ) ) {
		const copyBuckets = {
			...
			enabled: () => {
				return get$1( counts ).offloaded > 0 && get$1( current_settings ).hasOwnProperty( "bucket" ) && copyBuckets.bucket !== get$1( current_settings ).bucket;
			},
			isNextRoute: ( data ) => {
				if (
					!get$1( licence ).hasOwnProperty( "is_valid" ) ||
				...
				return get$1( location$1 ) === "/storage/bucket" || get$1( location$1 ) === "/storage/security" || get$1( location$1 ) === "/storage/update-acls";
			},
			bucket: get$1( current_settings ).hasOwnProperty( "bucket" ) ? get$1( current_settings ).bucket : "",
			...
			publicPathChanged: ( data ) => {
				if ( data.hasOwnProperty( "changed_settings" ) ) {
					...
					if (
						...
						get$1( current_settings ).hasOwnProperty( "use-yearmonth-folders" ) &&
						!get$1( current_settings )[ "use-yearmonth-folders" ]
					) {
						return false;
					}
					...
					if (
						...
						get$1( current_settings ).hasOwnProperty( "object-versioning" ) &&
						!get$1( current_settings )[ "object-versioning" ]
					) {
						return false;
					}
					...
					if (
						...
						get$1( current_settings ).hasOwnProperty( "enable-object-prefix" )
					) {
						return true;
					}
					...
					if (
						...
						get$1( current_settings ).hasOwnProperty( "enable-object-prefix" ) &&
						get$1( current_settings )[ "enable-object-prefix" ]
					) {
						return true;
					}
			...
			privatePathChanged: ( data ) => {
				if ( data.hasOwnProperty( "changed_settings" ) ) {
					...
					if (
						...
						get$1( current_settings ).hasOwnProperty( "enable-signed-urls" )
					) {
						return true;
					}
					...
					if (
						...
						get$1( current_settings ).hasOwnProperty( "enable-signed-urls" ) &&
						get$1( current_settings )[ "enable-signed-urls" ]
					) {
						return true;
					}
				}
		...
		const removeLocalFiles = {
			...
			onPreviousPage: () => {
				...
				for ( const previousPage of previousPages ) {
					if ( get$1( location$1 ) === previousPage.route ) {
						return true;
					}
				}
			...
			removeLocalFile: get$1( current_settings ).hasOwnProperty( "remove-local-file" ) ? get$1( current_settings )[ "remove-local-file" ] : false,
			setInitialRemoveLocalFile: ( data ) => {
				if (
					get$1( location$1 ) !== removeLocalFiles.route &&
			...
			isNextRoute: ( data ) => {
				...
				if ( data.hasOwnProperty( "changed_settings" ) ) {
					...
					if (
						...
						get$1( current_settings ).hasOwnProperty( "remove-local-file" ) &&
						removeLocalFiles.removeLocalFile !== get$1( current_settings )[ "remove-local-file" ] &&
						get$1( current_settings )[ "remove-local-file" ]
					) {
						return true;
					}
				}
				...
				if ( get$1( current_settings ).hasOwnProperty( "remove-local-file" ) ) {
					removeLocalFiles.removeLocalFile = get$1( current_settings )[ "remove-local-file" ];
				}
	...
	if ( enabledTools.hasOwnProperty( "uploader" ) ) {
		const uploader = {
			...
			copyToProvider: get$1( current_settings ).hasOwnProperty( "copy-to-s3" ) ? get$1( current_settings )[ "copy-to-s3" ] : false,
			setInitialCopyToProvider: ( data ) => {
				if (
					get$1( location$1 ) !== uploader.route &&
			...
			isNextRoute: ( data ) => {
				...
				if (
					...
					!get$1( licence ).is_valid ||
					!get$1( current_settings ).hasOwnProperty( "bucket" ) ||
					!get$1( counts ).hasOwnProperty( "not_offloaded" ) ||
					get$1( counts ).not_offloaded < 1
				) {
					return false;
				}
				...
				if ( data.hasOwnProperty( "changed_settings" ) ) {
					...
					if (
						...
						get$1( current_settings ).hasOwnProperty( "copy-to-s3" ) &&
						uploader.copyToProvider !== get$1( current_settings )[ "copy-to-s3" ] &&
						get$1( current_settings )[ "copy-to-s3" ]
					) {
						return true;
					}
				}
				...
				// We're not interested in showing prompt, just ensure local state is up to date.
				// NOTE: This handles syncing the local state when moving on from this prompt too.
				if ( get$1( current_settings ).hasOwnProperty( "copy-to-s3" ) ) {
					uploader.copyToProvider = get$1( current_settings )[ "copy-to-s3" ];
				}
	...
	if ( enabledTools.hasOwnProperty( "downloader" ) ) {
		const downloader = {
			...
			setInitialRemoveLocalFile: ( data ) => {
				if (
					get$1( location$1 ) !== downloader.route &&
			...
			isNextRoute: ( data ) => {
				...
				if ( data.hasOwnProperty( "changed_settings" ) ) {
					...
					if (
						data.changed_settings.includes( "remove-local-file" ) &&
						get$1( current_settings ).hasOwnProperty( "remove-local-file" ) &&
						downloader.removeLocalFile !== get$1( current_settings )[ "remove-local-file" ] &&
						!get$1( current_settings )[ "remove-local-file" ]
					) {
						return true;
					}
...
const toolSettingsNotifications = {
	/**
	 * Process local and server settings to return a new Map of inline notifications.
	 *
	 * @param {Map} notifications
...
var root$6 = add_locations(from_html(`<div class="header"><div class="header-wrapper"><img class="medallion"/> <h1> </h1> <div class="licence"><!></div></div></div>`), Header[FILENAME], [[14, 0, [[15, 1, [[16, 2], [17, 2], [18, 2]]]]]]);
...
var root$5 = add_locations(from_html(`<!> <!> <!>`, 1), Settings[FILENAME], []);
...
Header_1[FILENAME] = 'ui/pro/Header.svelte';

var root_3$1 = add_locations(from_html(`<div class="licence-type"><img/> <a class="licence" target="_blank"> </a></div> <p></p>`, 1), Header_1[FILENAME], [[12, 3, [[13, 4], [14, 4]]], [16, 3]]);
var root_4$1 = add_locations(from_html(`<div class="licence-type"><img/> <a class="licence" target="_blank"> </a></div>`), Header_1[FILENAME], [[18, 3, [[19, 4], [20, 4]]]]);
					...
					var consequent_1 = ($$anchor) => {
...

						{
							var consequent = ($$anchor) => {
								...
								html(p, () => $licence().customer, true);
								reset(p);

								template_effect(() => {
									set_attribute(img, 'src', $urls().assets + "img/icon/licence-checked.svg");
									set_attribute(img, 'alt', $strings().licence_checked);
									set_attribute(a, 'href', $urls().licenses);
									set_text(text, $licence().plan_plus_licence);
								});
							...
							var alternate = ($$anchor) => {
								...
								template_effect(() => {
									set_attribute(img_1, 'src', $urls().assets + "img/icon/error.svg");
									set_attribute(img_1, 'alt', $strings().licence_error);
									set_attribute(a_1, 'href', $urls().licenses);
									set_text(text_1, $licence().status_description);
								});
							...
							add_svelte_meta(
								() => if_block(node_1, ($$render) => {
									if ($licence().is_valid) $$render(consequent); else $$render(alternate, -1);
								}),
								'if',
								Header_1,
								11,
						...
						add_svelte_meta(
							() => Button($$anchor, {
								...
								children: wrap_snippet(Header_1, ($$anchor, $$slotProps) => {
									...
									template_effect(() => set_text(text_2, $strings().activate_licence));
									append($$anchor, text_2);
								}),
								$$slots: { default: true }
							}),
...
var root$4 = add_locations(from_html(`<li><a> </a></li>`), NavItem[FILENAME], [[11, 0, [[12, 1]]]]);
...
var root_5$1 = add_locations(from_html(`<td class="numeric"><a> </a></td>`), OffloadStatusFlyout[FILENAME], [[172, 7, [[173, 8]]]]);
...
var root_8$1 = add_locations(from_html(`<td class="numeric"> </td>`), OffloadStatusFlyout[FILENAME], [[183, 7]]);
var root_4 = add_locations(from_html(`<tr><td> </td><!><!></tr>`), OffloadStatusFlyout[FILENAME], [[169, 5, [[170, 6]]]]);
var root_9$1 = add_locations(from_html(`<tfoot><tr><td> </td><td class="numeric"> </td><td class="numeric"> </td></tr></tfoot>`), OffloadStatusFlyout[FILENAME], [[190, 5, [[191, 5, [[192, 6], [193, 6], [194, 6]]]]]]);
...
var root$3 = add_locations(from_html(`<!> <!>`, 1), OffloadStatusFlyout[FILENAME], []);
...
var root_1$1 = add_locations(from_html(`<img class="icon type"/>`), OffloadStatus[FILENAME], [[103, 3]]);
var root$2 = add_locations(from_html(`<div><div class="nav-status"><!> <p class="status-text"><strong> </strong> <span></span></p> <!></div> <!></div>`), OffloadStatus[FILENAME], [[92, 0, [[95, 1, [[110, 2, [[114, 3], [115, 3]]]]]]]]);
...
var root$1 = add_locations(from_html(`<div class="nav"><div class="items"><ul class="nav"></ul> <!></div></div>`), Nav[FILENAME], [[14, 0, [[15, 1, [[16, 2]]]]]]);
...
ToolRunningStatus[FILENAME] = 'ui/pro/ToolRunningStatus.svelte';

var root_1 = add_locations(from_html(`<div class="nav-status-wrapper tool-running"><div class="nav-status"><p class="status-text"><strong> </strong> <span></span></p> <!> <div class="animation-running"><img/></div></div> <!></div>`), ToolRunningStatus[FILENAME], [
	[
		72,
		1,
		[[76, 2, [[77, 3, [[78, 4], [79, 4]]], [88, 3, [[89, 4]]]]]]
	]
]);

function ToolRunningStatus($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, ToolRunningStatus);
	...
	function runningTool(tools, running) {
		return Object.values(tools).find((tool) => strict_equals(tool.id, running));
	}
	...
	let isRunning = tag(user_derived(() => !!$running()), 'isRunning');
	let tool = tag(user_derived(() => runningTool($tools(), $running())), 'tool');
	let icon = tag(user_derived(() => tools.icon(get(tool), get(isRunning), true)), 'icon');

	// Buttons should be disabled if another tool is running, current tool is in process of pausing or cancelling, or all tools locked.
	let disabled = tag(user_derived(() => get(isRunning) && ($running() && strict_equals($running(), get(tool).id, false) || get(tool).is_processing && get(tool).is_paused || get(tool).is_cancelled || $toolsLocked())), 'disabled');

	let starting = tag(user_derived(() => !!(get(isRunning) && get(tool).progress < 1 && !get(tool).is_paused)), 'starting');

	let status = tag(
		user_derived(() => get(isRunning)
			? "(" + numToShortString(get(tool).queue.processed) + "/" + numToShortString(get(tool).queue.total) + ") " + toolStatus(get(tool), get(isRunning))
			: ""),
		'status'
	);
	...
	let title = tag(
		user_derived(() => get(isRunning)
			? get(tool).name + ": " + get(tool).progress + "% (" + numToString(get(tool).queue.processed) + "/" + numToString(get(tool).queue.total) + ")"
			: ""),
		'title'
	);
	...
	let percentComplete = tag(user_derived(() => getPercentComplete(get(tool), get(isRunning))), 'percentComplete');
	var $$exports = { ...legacy_api() };
	var fragment = comment();
	var node = first_child(fragment);

	{
		var consequent = ($$anchor) => {
			...
			template_effect(() => {
				set_attribute(div_1, 'title', get(title));
				set_attribute(p, 'title', get(title));
				set_text(text, `${get(tool).progress ?? ''}%`);
				set_attribute(div_2, 'title', get(title));
				set_attribute(img, 'src', $urls().assets + 'img/icon/' + get(icon));
				set_attribute(img, 'alt', get(tool).status_description);
			});

			delegated('click', div_1, function click() {
				return push("/tools");
			});
...
Nav_1[FILENAME] = 'ui/pro/Nav.svelte';

var root_9 = add_locations(from_html(`<a href="/license"> </a>`), Nav_1[FILENAME], [[95, 8]]);
var root_10 = add_locations(from_html(`<a target="_blank" class="upgrade"> </a>`), Nav_1[FILENAME], [[99, 8]]);
var root_8 = add_locations(from_html(`<div class="details"><p class="title"> </p> <p> </p></div> <!>`, 1), Nav_1[FILENAME], [[90, 7, [[91, 8], [92, 8]]]]);
var root_5 = add_locations(from_html(`<!> <!>`, 1), Nav_1[FILENAME], []);

function Nav_1($$anchor, $$props) {
	check_target(new.target);
	push$1($$props, true, Nav_1);
	...
	const $offloadRemainingWithCount = () => (
		validate_store(offloadRemainingWithCount, 'offloadRemainingWithCount'),
		store_get(offloadRemainingWithCount, '$offloadRemainingWithCount', $$stores)
	);
	...
	const [$$stores, $$cleanup] = setup_stores();
	let flyoutButton = tag(state(proxy({})), 'flyoutButton');
	let expanded = tag(state(false), 'expanded');
	let hasFocus = tag(state(false), 'hasFocus');
	...
	function getOffloadRemainingDisabledMessage(licence, counts) {
		...
		if (licence.limit_info.counts_toward_limit && licence.limit_info.total > 0 && licence.limit_info.limit > 0 && licence.limit_info.total >= licence.limit_info.limit) {
	...
	let offloadRemainingDisabledMessage = tag(user_derived(() => getOffloadRemainingDisabledMessage($licence(), $counts())), 'offloadRemainingDisabledMessage');
	...
	add_svelte_meta(
		() => Nav($$anchor, {
			children: wrap_snippet(Nav_1, ($$anchor, $$slotProps) => {
				var fragment_1 = comment();
				var node = first_child(fragment_1);

				{
					var consequent = ($$anchor) => {
						add_svelte_meta(() => ToolRunningStatus($$anchor, {}), 'component', Nav_1, 72, 2, { componentTag: 'ToolRunningStatus' });
					};

					var alternate = ($$anchor) => {
						{
							const flyout = wrap_snippet(Nav_1, function ($$anchor) {
								validate_snippet_args(...arguments);

								{
									const footer = wrap_snippet(Nav_1, function ($$anchor) {
										validate_snippet_args(...arguments);
										...
										add_svelte_meta(
											() => PanelRow(node_1, {
												footer: true,
												class: 'offload-remaining',
												children: wrap_snippet(Nav_1, ($$anchor, $$slotProps) => {
													add_svelte_meta(
														() => Button($$anchor, {
															primary: true,
															get disabled() {
																return get(offloadRemainingDisabledMessage);
															},

															get title() {
																return get(offloadRemainingDisabledMessage);
															},
															onclick: startOffload,
															children: wrap_snippet(Nav_1, ($$anchor, $$slotProps) => {
																next();

																var text$1 = text();

																template_effect(() => set_text(text$1, $offloadRemainingWithCount()));
																append($$anchor, text$1);
															}),
															$$slots: { default: true }
														}),
												...
												children: wrap_snippet(Nav_1, ($$anchor, $$slotProps) => {
...

													{
														var consequent_1 = ($$anchor) => {
															...
															reset(a);
															action(a, ($$node) => link?.($$node));
															template_effect(() => set_text(text_3, $strings().activate_licence));
															append($$anchor, a);
														};
														...
														var consequent_2 = ($$anchor) => {
															...
															template_effect(() => {
																set_attribute(a_1, 'href', $urls().licenses);
																set_text(text_4, $strings().upgrade_plan_cta);
															});
														...
														add_svelte_meta(
															() => if_block(node_3, ($$render) => {
																if (!$licence().is_set) $$render(consequent_1); else if (strict_equals($licence().limit_info.limit, 0, false)) $$render(consequent_2, 1);
															}),
															'if',
															Nav_1,
															94,
													...
													template_effect(() => {
														set_text(text_1, $strings().plan_usage_title);
														set_text(text_2, $licence().plan_usage);
													});
									...
									add_svelte_meta(
										() => OffloadStatusFlyout($$anchor, {
											...
											set hasFocus($$value) {
												set(hasFocus, $$value, true);
											},

											get buttonRef() {
												return get(flyoutButton);
											},

											set buttonRef($$value) {
												set(flyoutButton, $$value, true);
											},
											footer,
											$$slots: { footer: true }
										}),
					...
					add_svelte_meta(
						() => if_block(node, ($$render) => {
							if (!!$running()) $$render(consequent); else $$render(alternate, -1);
						}),
						'if',
						Nav_1,
						71,
...
var root = add_locations(from_html(`<!> <div><!> <!></div>`, 1), Pages[FILENAME], [[21, 0]]);
...
Settings_1[FILENAME] = 'ui/pro/Settings.svelte';
...
function Settings_1($$anchor, $$props) {
	...
	const $assetsSettingsChanged = () => (
		validate_store(assetsSettingsChanged, 'assetsSettingsChanged'),
		store_get(assetsSettingsChanged, '$assetsSettingsChanged', $$stores)
	);
	...
	const $assetsNeedsRefresh = () => (
		validate_store(assetsNeedsRefresh, 'assetsNeedsRefresh'),
		store_get(assetsNeedsRefresh, '$assetsNeedsRefresh', $$stores)
	);
	...
	async function handleStateUpdate(config) {
		...
		store_set(settingsLocked, _settingsLocked);
		store_set(toolsLocked, _toolsLocked);
		store_set(assetsSettingsLocked, _assetsSettingsLocked);
