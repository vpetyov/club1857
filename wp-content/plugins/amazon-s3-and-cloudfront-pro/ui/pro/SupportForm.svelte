<script>
	...
	let disabledReason = $derived( getDisabledReason( email, subject, message ) );
...
<div class="actions">
	...
	<Button primary onclick={submitSupportRequest} disabled={disabledReason} title={disabledReason}>{$strings.send_email}</Button>
</div>
