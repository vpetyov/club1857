...
if (!function_exists('porter_pub_get_custom_page_meta_fields')) {
function porter_pub_get_custom_page_meta_fields() {
	$cmsmasters_option = porter_pub_get_global_options();
	
	
	$cmsmasters_global_layout = (isset($cmsmasters_option['porter-pub' . '_layout']) && $cmsmasters_option['porter-pub' . '_layout'] !== '') ? $cmsmasters_option['porter-pub' . '_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_header_overlaps = (isset($cmsmasters_option['porter-pub' . '_header_overlaps']) && $cmsmasters_option['porter-pub' . '_header_overlaps'] !== '') ? (($cmsmasters_option['porter-pub' . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Page Layout', 'porter-pub'), 
			'desc'	=> '</br>' . esc_html__('Choosing layout with a sidebar please make sure to add widgets in the Appearance - Widgets tab. The empty sidebar won\'t be displayed.', 'porter-pub'), 
			'id'	=> 'cmsmasters_layout', 
			'type'	=> 'radio_img', 
			'hide'	=> '', 
			...
			'options' => array( 
				'r_sidebar' => array( 
					...
					'label' => esc_html__('Right Sidebar', 'porter-pub'), 
					'value'	=> 'r_sidebar' 
				), 
				'l_sidebar' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/sidebar_l.jpg', 
					'label' => esc_html__('Left Sidebar', 'porter-pub'), 
					'value'	=> 'l_sidebar' 
				), 
				'fullwidth' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/fullwidth.jpg', 
					'label' => esc_html__('Full Width', 'porter-pub'), 
					'value'	=> 'fullwidth' 
				) 
			) 
		), 
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'porter-pub'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'porter-pub'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'porter-pub'), 
		...
		array( 
			'label'	=> esc_html__('Choose Right\Left Sidebar', 'porter-pub'), 
			'desc'	=> '', 
