...
// var_dump(date("d.m", strtotime($event->start_date)));die();
?>
<div class="tribe-events-calendar-latest-past__event-datetime-wrapper tribe-common-b2">
	<?php $this->template( 'latest-past/event/date/featured', [ 'event' => $event ] ); ?>
	<time class="tribe-events-calendar-latest-past__event-datetime child-event-date-custom" datetime="<?php echo esc_attr( $event_date_attr ); ?>">
